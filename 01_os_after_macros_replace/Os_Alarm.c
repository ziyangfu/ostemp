 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionSetEvent (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionActivateTask (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionIncrementCounter (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionCallback (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_AlarmType OS_VAR_NOINIT *   Os_AlarmGetDyn (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AlarmSetEventConfigType OS_CONST *   Os_AlarmJob2AlarmSetEvent (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AlarmActivateTaskConfigType OS_CONST *   Os_AlarmJob2AlarmActivateTask (
  const   Os_JobConfigType OS_CONST * Job
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AlarmIncrementCounterConfigType OS_CONST *   Os_AlarmJob2AlarmIncrementCounter (
  const   Os_JobConfigType OS_CONST * Job
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AlarmCallbackConfigType OS_CONST *   Os_AlarmJob2AlarmCallback (
  const   Os_JobConfigType OS_CONST * Job
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_AlarmCancelOrReload (
  const   Os_AlarmConfigType OS_CONST * Alarm
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_AlarmSetRelAlarm (
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickType Increment,
  TickType Cycle
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_AlarmGetAlarm (
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickRefType Tick
);
 ...
 *  \pre            Given values have been checked before.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_AlarmSetAbsAlarm (
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickType Start,
  TickType Cycle
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_AlarmCancelAlarm (
  const   Os_AlarmConfigType OS_CONST * Alarm
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmCheckIsCanceled (
  const   Os_AlarmConfigType OS_CONST * Alarm
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmCheckIsSet (
  const   Os_AlarmConfigType OS_CONST * Alarm
);
 ...
 *  Os_AlarmHasActionSetEvent()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionSetEvent (
  void
)
{
 ...
 *  Os_AlarmHasActionActivateTask()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionActivateTask (
  void
)
{
 ...
 *  Os_AlarmHasActionIncrementCounter()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionIncrementCounter (
  void
)
{
 ...
 *  Os_AlarmHasActionCallback()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AlarmHasActionCallback (
  void
)
{
...
OS_ALWAYS_INLINE static inline
  Os_AlarmType OS_VAR_NOINIT *   Os_AlarmGetDyn (
  const   Os_AlarmConfigType OS_CONST * Alarm
)
{
  return (  Os_AlarmType OS_VAR_NOINIT *)Os_JobGetDyn(&(Alarm->Job));                                    /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* SBSW_OS_AL_JOBGETDYN_001 */
}
...
{
  return (const   Os_AlarmSetEventConfigType OS_CONST *)Job;                                                 /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_3305 */
}
...
{
  return (const   Os_AlarmActivateTaskConfigType OS_CONST *)Job;                                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_AlarmIncrementCounterConfigType OS_CONST *)Job;                                         /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_AlarmCallbackConfigType OS_CONST *)Job;                                                 /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
    Os_AlarmType OS_VAR_NOINIT * alarmDyn;
  Os_TickType cycle;
...
{
  const   Os_AlarmAutostartConfigType OS_CONST * autostartConfig;
    Os_AlarmType OS_VAR_NOINIT * alarmDyn;
 ...
 *
 */
void     Os_AlarmActionSetEvent
(
  const   Os_JobConfigType OS_CONST * Job
)
{
  Os_StatusType status;
  const   Os_AlarmSetEventConfigType OS_CONST * alarm;
 ...
 *
 */
void     Os_AlarmActionActivateTask
(
  const   Os_JobConfigType OS_CONST * Job
)
{
  Os_StatusType status;
  const   Os_AlarmActivateTaskConfigType OS_CONST * alarm;
 ...
 *
 */
void     Os_AlarmActionIncrementCounter
(
  const   Os_JobConfigType OS_CONST * Job
)
{
  Os_StatusType status;
  const   Os_AlarmIncrementCounterConfigType OS_CONST * alarm;
 ...
 *
 */
void     Os_AlarmActionCallback
(
  const   Os_JobConfigType OS_CONST * Job
)
{
  const   Os_AlarmCallbackConfigType OS_CONST * alarm;
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmGetAlarmLocal                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickRefType Tick
)
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmSetRelAlarmLocal                                                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickType Increment,
  TickType Cycle
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmSetAbsAlarmLocal                                                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickType Start,
  TickType Cycle
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmCancelAlarmLocal                                                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AlarmConfigType OS_CONST * Alarm
)
{
 ...
 *
 */
Os_StatusType     Os_Api_GetAlarmBase
(
  AlarmType AlarmID,
...
)
{
  ...
  {
    const   Os_AlarmConfigType OS_CONST * me;
    ...
    {
      const   Os_CounterCharacteristicsConfigType OS_CONST * characteristics;
...
)
{
  ...
  else
  {
    ...
    {
      const   Os_CoreAsrConfigType OS_CONST * targetCore;
 ...
 *
 */
Os_StatusType     Os_Api_SetRelAlarm
(
  AlarmType AlarmID,
  TickType Increment,
  TickType Cycle
 ...
 *
 */
Os_StatusType     Os_Api_SetAbsAlarm
(
  AlarmType AlarmID,
  TickType Start,
  TickType Cycle
 ...
 *
 */
Os_StatusType     Os_Api_CancelAlarm
(
  AlarmType AlarmID
)
{
...
\CM CM_OS_ALARMID2ALARM_M
      Verify that:
        1. each alarm pointer except the last in OsCfg_AlarmRefs is no ((void *)0),
...
\CM CM_OS_ALARMGETAPPLICATION_M
      Verify that the OwnerApplication reference in each alarm instance is a non ((void *)0).
