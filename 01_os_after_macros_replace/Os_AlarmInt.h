 ...
 **********************************************************************************************************************/
typedef P2void    , Os_AlarmCallbackType(void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CoreAsrConfigType OS_CONST *   Os_AlarmGetCore (
  const   Os_AlarmConfigType OS_CONST * Alarm
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AlarmConfigType OS_CONST *   Os_AlarmId2Alarm (
  AlarmType AlarmId
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AppConfigType OS_CONST *   Os_AlarmGetApplication (
  const   Os_AlarmConfigType OS_CONST * Alarm
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmGetAlarmLocal
(
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickRefType Tick
);
 ...
 *  \pre            Given values have been checked before.
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmSetRelAlarmLocal
(
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickType Increment,
  TickType Cycle
 ...
 *  \pre            Given values have been checked before.
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmSetAbsAlarmLocal
(
  const   Os_AlarmConfigType OS_CONST * Alarm,
  TickType Start,
  TickType Cycle
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AlarmCancelAlarmLocal
(
  const   Os_AlarmConfigType OS_CONST * Alarm
);
