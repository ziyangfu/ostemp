...
typedef const   Os_TaskConfigType OS_CONST * Os_TaskConfigRefType;

/*! Pointer to Counter configuration. */
typedef const   Os_CounterConfigType OS_CONST * Os_CounterConfigRefType;

/*! Pointer to Alarm configuration . */
typedef const   Os_AlarmConfigType OS_CONST * Os_AlarmConfigRefType;

/*! Pointer to Alarm configuration. */
typedef const   Os_SchTConfigType OS_CONST * Os_SchTConfigRefType;

/*! Pointer to service functions. */
typedef const   Os_ServiceConfigType OS_CONST * Os_ServiceConfigRefType;
...
struct Os_AppConfigType_Tag
{
  ...
  /*! Tasks. */
  const   Os_TaskConfigRefType OS_CONST * TaskRefs;

  /*! Number of tasks. */
  Os_ObjIdxType TaskCount;

  /*! ISRs of category 2. */
  const   Os_IsrConfigRefType OS_CONST * IsrCat2Refs;

  /*! Number of ISRs of category 2. */
  Os_ObjIdxType IsrCat2Count;

  /*! ISRs of category 1. */
  const   Os_IsrCat1ConfigRefType OS_CONST * IsrCat1Refs;

  /*! Number of ISRs of category 1. */
  Os_ObjIdxType IsrCat1Count;

  /*! Counters. */
  const   Os_CounterConfigRefType OS_CONST * CounterRefs;

  /*! Number of counters. */
  Os_ObjIdxType CounterCount;

  /*! List of Alarm of this core. */
  const   Os_AlarmConfigRefType OS_CONST * AlarmRefs;

  /*! Number of Alarms. */
  Os_ObjIdxType AlarmCount;

  /*! List of Schedule Tables of this core. */
  const   Os_SchTConfigRefType OS_CONST * SchTRefs;
   ...
   *  \trace      SPEC-63800 */
  const   Os_ServiceConfigRefType OS_CONST * ServiceFunctions;
  ...
  /*! Restart Task. */
  const   Os_TaskConfigType OS_CONST * RestartTask;
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_AppSetNotAccessible (
 ...
 *  \trace          SPEC-64005
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_AppStart (
  const   Os_AppConfigType OS_CONST * App
);
...
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AppCheckAccess (
  const   Os_AppConfigType OS_CONST * App, Os_AppAccessMaskType AccessMask
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AppIsCoreLocal (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AppIsKernelApp (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CoreAsrConfigType OS_CONST *   Os_AppGetCore (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline ApplicationType   Os_AppGetId (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_HookCallbackConfigType OS_CONST *   Os_AppGetStartupHook (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_HookStatusHookConfigType OS_CONST *   Os_AppGetErrorHook (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \trace          SPEC-63704
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_HookStatusHookConfigType OS_CONST *   Os_AppGetShutdownHook (
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AppConfigType OS_CONST *   Os_AppId2App (
  ApplicationType AppId
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_AppIsRestartTaskAvailable (
    const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
Os_StatusType     Os_AppTerminateApplicationLocal
(
  const   Os_AppConfigType OS_CONST * App,
  RestartType RestartOption,
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_AppGetApplicationStateLocal
(
  const   Os_AppConfigType OS_CONST * App,
