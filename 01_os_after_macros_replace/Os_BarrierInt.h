...
typedef const   Os_BarrierBaseConfigType OS_VAR_NOINIT * Os_BarrierAttendeeRefType;
...
struct Os_BarrierBaseConfigType_Tag
{
  ...
  const   Os_BarrierAttendeeRefType OS_VAR_NOINIT * AttendeeRefs;
 ...
 *  \trace        CREQ-208524
 **********************************************************************************************************************/
Os_StatusType     Os_Api_BarrierSynchronize(Os_BarrierIdType BarrierID);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_BarrierIsEnabled (void);
