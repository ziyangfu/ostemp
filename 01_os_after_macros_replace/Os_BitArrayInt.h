...
#define OS_BITARRAY_DECLARE(Name, BitSize, MemClass)  Os_BitFieldType MemClass  Name[OS_BITARRAY_SIZE(BitSize)]   /* PRQA S 0850, 3410 */ /* MD_MSR_MacroArgumentEmpty, MD_Os_Rule20.7_3410_Decl */
...
typedef struct
{
  /*! The dynamic data of this bit array. */
    Os_BitArrayType OS_APPL_DATA * Dyn;
  /*! Array of bit fields. */
    Os_BitFieldType OS_APPL_DATA * Data;
 ...
 *  \pre        -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_BitArrayIndexType   Os_BitArrayIdxIsValid (
  const   Os_BitArrayConfigType OS_VAR_NOINIT_FAST * BitArray,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline uint8   Os_BitArrayGetIndexBitwidth (void);
 ...
 *  \pre        -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_BitArrayIndexType   Os_BitArrayIdxGetAllocationIdx (
 ...
 *  \pre        -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_BitArrayIndexType   Os_BitArrayIdxGetFieldIdx (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_BitArrayInit (
  const   Os_BitArrayConfigType OS_VAR_NOINIT_FAST * BitArray
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_BitArraySetBit (
  const   Os_BitArrayConfigType OS_VAR_NOINIT_FAST * BitArray,
  Os_BitArrayIndexType BitIdx
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_BitArraySetBitInternal (
  const   Os_BitArrayConfigType OS_VAR_NOINIT_FAST * BitArray,
  Os_BitArrayIndexType BitIdx
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_BitArrayClearBit (
  const   Os_BitArrayConfigType OS_VAR_NOINIT_FAST * BitArray,
  Os_BitArrayIndexType BitIdx
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_BitArrayIndexType   Os_BitArrayCountLeadingZeros (
  const   Os_BitArrayConfigType OS_VAR_NOINIT_FAST * BitArray
);
