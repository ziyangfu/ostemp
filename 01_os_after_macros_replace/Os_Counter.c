 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_CounterHasSwCounter (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_CounterUserModulo (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_CounterCheckIsSoftwareCounter (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline TickType   Os_CounterGetPhysicalValue (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
static inline Os_TickType     Os_CounterAbsValue2TimerAbsValue
(
  const   Os_CounterConfigType OS_CONST * Counter,
  Os_TickType Now,
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline TickType   Os_CounterGetUserValue (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_CounterSetCompareValue (
  const   Os_CounterConfigType OS_CONST * Counter,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_CounterGetUserValueInternal (
  const   Os_CounterConfigType OS_CONST * Counter,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TimerSwConfigType OS_CONST *   Os_Counter2TimerSw (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TimerPitConfigType OS_CONST *   Os_Counter2TimerPit (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TimerHrtConfigType OS_CONST *   Os_Counter2TimerHrt (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 *  \pre            Counter is based on a high resolution hardware timer.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TimerPfrtConfigType OS_CONST *   Os_Counter2TimerPfrt (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_TickType   Os_CounterUserModulo (
  const   Os_CounterConfigType OS_CONST * Counter,
  Os_TickType Value
)
{
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_CounterCheckIsSoftwareCounter (
    const   Os_CounterConfigType OS_CONST * Counter
)
{
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StatusType   Os_CounterGetUserValueInternal (
  const   Os_CounterConfigType OS_CONST * Counter,
  CounterType CounterID,
  TickRefType Value
)
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline TickType   Os_CounterGetPhysicalValue (
  const   Os_CounterConfigType OS_CONST * Counter
)
{
 ...
 */
OS_ALWAYS_INLINE 
static inline TickType   Os_CounterGetUserValue (
  const   Os_CounterConfigType OS_CONST * Counter
)
{
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline void   Os_CounterSetCompareValue (
  const   Os_CounterConfigType OS_CONST * Counter,
  Os_TickType ExpirationTime
)
{
 ...
 *  Os_CounterGetValue()
 **********************************************************************************************************************/
Os_TickType     Os_CounterGetValue
(
  const   Os_CounterConfigType OS_CONST * Counter
)
{
 ...
 *  Os_CounterGetModulo()
 **********************************************************************************************************************/
Os_TickType     Os_CounterGetModulo
(
  const   Os_CounterConfigType OS_CONST * Counter,
  Os_TickType Operand
)
 ...
 *
 */
Os_StatusType     Os_CounterGetUserValueLocal
(
  const   Os_CounterConfigType OS_CONST * Counter,
  TickRefType Value
)
 ...
 *
 */
void     Os_CounterWorkJobs
(
  const   Os_CounterConfigType OS_CONST * Counter
)
{
  const   Os_JobConfigType OS_CONST * job;
  const   Os_PriorityQueueConfigType OS_CONST * jobQueue = &(Counter->JobQueue);
  Os_IntStateType interruptState;
  uint8 jobCounter = 0u;
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_TimerSwConfigType OS_CONST *   Os_Counter2TimerSw (
  const   Os_CounterConfigType OS_CONST * Counter
)
{
  return (const   Os_TimerSwConfigType OS_CONST *)Counter;                                                   /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 *  Os_Counter2TimerPit()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE                                                                                            /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
static inline const   Os_TimerPitConfigType OS_CONST *   Os_Counter2TimerPit (
  const   Os_CounterConfigType OS_CONST * Counter
)                                                                                                                      /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
{
  return (const   Os_TimerPitConfigType OS_CONST *)Counter;                                                  /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 *  Os_Counter2TimerHrt()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE                                                                                            /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
static inline const   Os_TimerHrtConfigType OS_CONST *   Os_Counter2TimerHrt (
  const   Os_CounterConfigType OS_CONST * Counter
)                                                                                                                      /* COV_OS_HALPLATFORMFRTUNSUPPORTED_XX */
{
  return (const   Os_TimerHrtConfigType OS_CONST *)Counter;                                                  /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_TimerPfrtConfigType OS_CONST *)Counter;                                                 /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
)
{
  ...
  const   Os_PriorityQueueConfigType OS_CONST * jobQueue;
 ...
 *
 */
void     Os_CounterDeleteJob
(
  const   Os_CounterConfigType OS_CONST * Counter,
  const   Os_JobConfigType OS_CONST * Job
)
{
  const   Os_JobConfigType OS_CONST * topJob;
  const   Os_PriorityQueueConfigType OS_CONST * jobQueue;
  ...
  Os_Assert((Os_StdReturnType)(topJob != ((void *)0)));                                                                    /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
 ...
 *
 */
Os_StatusType     Os_CounterIncrementInternal
(
  const   Os_CounterConfigType OS_CONST * Counter
)
{
 ...
 *
 */
Os_StatusType     Os_Api_IncrementCounter
(
  CounterType CounterID
)
{
  ...
  {
    const   Os_CounterConfigType OS_CONST * me = Os_CounterId2Counter(CounterID);
    const   Os_AppConfigType OS_CONST * currentApp = Os_ThreadGetCurrentApplication(currentThread);          /* SBSW_OS_CNT_THREADGETCURRENTAPPLICATION_001 */
    ...
    else
    {
      ...
      if(OS_LIKELY(status == OS_STATUS_OK))
      {
        ...
        {
          const   Os_CoreAsrConfigType OS_CONST * localCore = Os_ThreadGetCore(currentThread);               /* SBSW_OS_CNT_THREADGETCORE_001 */
          const   Os_SchedulerConfigType OS_CONST * scheduler = Os_CoreGetScheduler(localCore);              /* SBSW_OS_CNT_COREGETSCHEDULER_001 */
 ...
 *
 */
Os_StatusType     Os_Api_GetCounterValue
(
  CounterType CounterID,
  TickRefType Value
)
 ...
 *
 */
Os_StatusType     Os_Api_GetElapsedValue
(
  CounterType CounterID,
  TickRefType Value,
...
\CM CM_OS_COUNTERID2COUNTER_M
      Verify that:
        1. each counter pointer in OsCfg_CounterRefs is no ((void *)0),
...
\CM CM_OS_COUNTERGETAPPLICATION_M
      Verify that the OwnerApplication pointer of each counter in OsCfg_CounterRefs is no ((void *)0).

\CM CM_OS_COUNTERGETCORE_M
      Verify that the Core pointer of each counter in OsCfg_CounterRefs is no ((void *)0).
