 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_CounterHasPfrtCounter (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_CounterHasHrtCounter (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_CounterHasPitCounter (
  void
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CounterConfigType OS_CONST *   Os_CounterId2Counter (
  CounterType CounterId
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AppConfigType OS_CONST *   Os_CounterGetApplication (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CoreAsrConfigType OS_CONST *   Os_CounterGetCore (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_CounterCheckValueGeMinCycleOrZero (
  const   Os_CounterConfigType OS_CONST * Counter,
  TickType Cycle
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_CounterGetMaxAllowedValue (
  const   Os_CounterConfigType OS_CONST * Counter
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_CounterGetMaxCountingValue (
  const   Os_CounterConfigType OS_CONST * Counter
);
