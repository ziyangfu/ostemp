...
typedef struct
{
  const   Os_TaskConfigType OS_APPL_DATA * Value; /*!< A pointer to the managed value. */
}Os_DequeNodeType;
...
typedef struct
{
   ...
   *  \details  Just read and write index, buffer has separate pointer. */
    Os_DequeType OS_APPL_DATA * Dyn;

  /*! The data buffer of the deque */
    Os_DequeNodeType OS_APPL_DATA * Buffer;
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_DequeIdxDecrement (
 ...
 *  \pre            *Index must be in range [0 ... Size-1]
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_DequeIdxIncrement (
    uint32 OS_APPL_DATA * Index,
  const uint32 Size
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_DequeInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_DequeDeleteTop (
  const   Os_DequeConfigType OS_APPL_DATA * Deque
);
 ...
 *  \pre            Deque must not be empty.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TaskConfigType     *   Os_DequePeek (
  const   Os_DequeConfigType OS_APPL_DATA * Deque
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_DequeDelete (
  const   Os_DequeConfigType OS_APPL_DATA * Deque,
  const   Os_TaskConfigType   * Value
);
