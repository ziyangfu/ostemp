 ...
 **********************************************************************************************************************/
static ProtectionReturnType     Os_ErrVerifyProtectionReaction
(
 ...
 *  \trace        SPEC-63562
 **********************************************************************************************************************/
static void     Os_ErrHandleProtectionReaction
(
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrSetErrorDetails (
    Os_ErrorInformationType OS_APPL_VAR * ErrorDetails,
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsInternalExceptionDetectionSupported (
  void
);
 ...
 *  \synchronous    TRUE
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsAddressInsideSection (
  const   Os_LinkerSectionLabelsType OS_CONST * Section,
 ...
 *  \synchronous  TRUE
 **********************************************************************************************************************/
static Os_StdReturnType     Os_ErrIsOsInternalException
(
...
)
{
  ...
  {
    const   Os_ThreadConfigType OS_CONST * responsibleThread;
    const   Os_AppConfigType OS_CONST * responsibleApplication;
    ...
    if(OS_UNLIKELY(responsibleThread == ((void *)0)))                                                                      /* COV_OS_INVSTATE */
    {
    ...
    if(OS_UNLIKELY(responsibleApplication == ((void *)0)))                                                                 /* COV_OS_INVSTATE */
    {
 ...
 *  Os_ErrIsInternalExceptionDetectionSupported()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsInternalExceptionDetectionSupported (void)
{
 ...
 *
 */
AlarmType     Os_ErrorGetParameter_AlarmType(Os_ErrorParmIndexType ParamIndex)
{
 ...
 *
 */
ApplicationType     Os_ErrorGetParameter_ApplicationType(Os_ErrorParmIndexType ParamIndex)
{
  Os_Assert(Os_ErrIsValueLo((uint32)ParamIndex, (uint32)OS_ERRORPARAMINDEX_COUNT));
 ...
 *
 */
CoreIdType     Os_ErrorGetParameter_CoreIdType(Os_ErrorParmIndexType ParamIndex)                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  Os_Assert(Os_ErrIsValueLo((uint32)ParamIndex, (uint32)OS_ERRORPARAMINDEX_COUNT));
 ...
 *
 */
Os_ExceptionContextRefType     Os_ErrorGetParameter_ExceptionContextRefType(Os_ErrorParmIndexType ParamIndex)
{
  Os_Assert(Os_ErrIsValueLo((uint32)ParamIndex, (uint32)OS_ERRORPARAMINDEX_COUNT));
 ...
 *
 */
IdleModeType     Os_ErrorGetParameter_IdleModeType(Os_ErrorParmIndexType ParamIndex)                         /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  Os_Assert(Os_ErrIsValueLo((uint32)ParamIndex, (uint32)OS_ERRORPARAMINDEX_COUNT));
 ...
 *
 */
Os_InterruptSourceIdRefType     Os_ErrorGetParameter_InterruptSourceIdRefType                                /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
 ...
 *
 */
Os_ExceptionSourceIdRefType     Os_ErrorGetParameter_ExceptionSourceIdRefType                                /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
 ...
 *
 */
ScheduleTableType     Os_ErrorGetParameter_ScheduleTableType(Os_ErrorParmIndexType ParamIndex)
{
  Os_Assert(Os_ErrIsValueLo((uint32)ParamIndex, (uint32)OS_ERRORPARAMINDEX_COUNT));
 ...
 *
 */
Os_BarrierIdType     Os_ErrorGetParameter_BarrierIdType(Os_ErrorParmIndexType ParamIndex)                    /* COV_OS_TESTSUITEOSC4998 */
{
  Os_Assert(Os_ErrIsValueLo((uint32)ParamIndex, (uint32)OS_ERRORPARAMINDEX_COUNT));
 ...
 *
 */
TrustedFunctionIndexType     Os_ErrorGetParameter_TrustedFunctionIndexType                                   /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
 ...
 *
 */
TrustedFunctionParameterRefType     Os_ErrorGetParameter_TrustedFunctionParameterRefType                     /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
 ...
 *
 */
Os_FastTrustedFunctionIndexType     Os_ErrorGetParameter_FastTrustedFunctionIndexType                        /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
 ...
 *
 */
Os_NonTrustedFunctionIndexType     Os_ErrorGetParameter_Os_NonTrustedFunctionIndexType                       /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
 ...
 *
 */
Os_NonTrustedFunctionParameterRefType     Os_ErrorGetParameter_Os_NonTrustedFunctionParameterRefType         /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  Os_ErrorParmIndexType ParamIndex
)
{
...
)
{
  ...
  if ((currentContext & nonPropagatingContext) == 0u)                                                                   /* PRQA S 4404 */ /* MD_Os_C90BooleanCompatibility */
  {
    const   Os_CoreAsrConfigType OS_CONST * localCore;
      Os_ErrorType OS_VAR_NOINIT * lastError;
...
\CM CM_OS_ERRCHECKPOINTERISNOTNULL_N
      Function is able to handle ((void *)0).
...
\CM CM_OS_ERROR_CODESECTIONS_M
      Verify that
      each element in OsCfg_OsCode_Sections except the last is a non ((void *)0) and
