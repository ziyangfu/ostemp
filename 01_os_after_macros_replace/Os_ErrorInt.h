...
void     Os_ErrInit
(
    Os_ErrorType OS_VAR_NOINIT * Error
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_AddressOfConstType   Os_ErrGetExceptionInstructionAddress (
  const   Os_ErrorType OS_CONST * Error
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportDisableAllInterrupts (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportEnableAllInterrupts (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportSuspendAllInterrupts (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportResumeAllInterrupts (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportSuspendOSInterrupts (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportResumeOSInterrupts (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportIsrEpilogue (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportTimerIsr (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportCallTrustedFunction (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportCallFastTrustedFunction (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportCallNonTrustedFunction (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportStartScheduleTableRel (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportStartScheduleTableAbs (
  Os_StatusType Status,
  ScheduleTableType ScheduleTableID,
  TickType Start
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportStopScheduleTable (
  Os_StatusType Status,
  ScheduleTableType ScheduleTableID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportNextScheduleTable (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportStartScheduleTableSynchron (
  Os_StatusType Status,
  ScheduleTableType ScheduleTableID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSyncScheduleTable (
  Os_StatusType Status,
  ScheduleTableType ScheduleTableID,
  TickType Value
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSetScheduleTableAsync (
  Os_StatusType Status,
  ScheduleTableType ScheduleTableID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetScheduleTableStatus (
  Os_StatusType Status,
  ScheduleTableType ScheduleTableID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportSchTExPoActivateTask (
  Os_StatusType Status,
  TaskType TaskID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportSchTExPoSetEvent (
  Os_StatusType Status,
  TaskType TaskID,
  EventMaskType Mask
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportIncrementCounter (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetCounterValue (
  Os_StatusType Status,
  CounterType CounterID,
  TickRefType Value
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetElapsedValue (
  Os_StatusType Status,
  CounterType CounterID,
  TickRefType Value,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportTerminateApplication (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportAllowAccess (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetApplicationState (
  Os_StatusType Status,
  ApplicationType Application,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetSpinlock (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportReleaseSpinlock (
  Os_StatusType Status,
  SpinlockIdType SpinlockId
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportTryToGetSpinlock (
  Os_StatusType Status,
  SpinlockIdType SpinlockId,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportControlIdle (
  Os_StatusType Status,
  CoreIdType CoreID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetExceptionContext (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSetExceptionContext (
  Os_StatusType Status,
  Os_ExceptionContextRefType Context
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetUnhandledIrq (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetUnhandledExc (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportAlarmActionSetEvent (
  Os_StatusType Status,
  TaskType Task,
  EventMaskType Mask
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportAlarmActionActivateTask (
  Os_StatusType Status,
  TaskType Task
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportAlarmActionIncrementCounter (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetTaskStackUsage (
  Os_StatusType Status,
  TaskType TaskID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetISRStackUsage (
  Os_StatusType Status,
  ISRType IsrID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetKernelStackUsage (
  Os_StatusType Status,
  CoreIdType CoreID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetStartupHookStackUsage (
  Os_StatusType Status,
  CoreIdType CoreID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetErrorHookStackUsage (
  Os_StatusType Status,
  CoreIdType CoreID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetShutdownHookStackUsage (
  Os_StatusType Status,
  CoreIdType CoreID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetProtectionHookStackUsage (
  Os_StatusType Status,
  CoreIdType CoreID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ErrReportGetNonTrustedFunctionStackUsage (
  Os_StatusType Status,
  Os_NonTrustedFunctionIndexType FunctionIndex
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportDisableInterruptSource (
  Os_StatusType Status,
  ISRType ISRID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportEnableInterruptSource (
  Os_StatusType Status,
  ISRType ISRID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportInitialEnableInterruptSources (
  Os_StatusType Status,
  boolean ClearPending
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportClearPendingInterrupt (
  Os_StatusType Status,
  ISRType ISRID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportIsInterruptSourceEnabled (
  Os_StatusType Status,
  ISRType ISRID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportIsInterruptPending (
  Os_StatusType Status,
  ISRType ISRID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportBarrierSynchronize (
  Os_StatusType Status,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportActivateTask (
  Os_StatusType Status,
  TaskType TaskID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportTerminateTask (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportChainTask (
  Os_StatusType Status,
  TaskType TaskID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetTaskID (
  Os_StatusType Status,
  TaskRefType TaskID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetTaskState (
  Os_StatusType Status,
  TaskType TaskID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSchedule (
  Os_StatusType Status
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSetEvent (
  Os_StatusType Status,
  TaskType TaskID,
  EventMaskType Mask
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportClearEvent (
  Os_StatusType Status,
  EventMaskType Mask
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetEvent (
  Os_StatusType Status,
  TaskType TaskID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportWaitEvent (
  Os_StatusType Status,
  EventMaskType Mask
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetAlarmBase (
  Os_StatusType Status,
  AlarmType AlarmID,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetAlarm (
  Os_StatusType Status,
  AlarmType AlarmID,
  TickRefType Tick
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSetRelAlarm (
  Os_StatusType Status,
  AlarmType AlarmID,
  TickType Increment,
  TickType Cycle
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportSetAbsAlarm (
  Os_StatusType Status,
  AlarmType AlarmID,
  TickType Start,
  TickType Cycle
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportCancelAlarm (
  Os_StatusType Status,
  AlarmType AlarmID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportGetResource (
  Os_StatusType Status,
  ResourceType ResID
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrReportReleaseResource (
  Os_StatusType Status,
  ResourceType ResID
);
 ...
 *  \trace        CREQ-133061
 **********************************************************************************************************************/
OS_NORETURN void   Os_ErrKernelPanic (void);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ErrIsValueLo (
  uint32 Id,
  uint32 Compare
);
 ...
 *  \trace        SPEC-63567
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrExtendedCheck (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_ErrSetOkInStdStatus (
  Os_StatusType Value
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrServiceProtectionCheck (
  Os_StdReturnType Value
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Assert (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrCheckPointerIsNotNull (
  const   volatile void OS_APPL_DATA * Pointer
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrCheckIsBoolean (
  boolean Value
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline StatusType   Os_ErrOsStatus2UserStatus (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsPropagationRequired (
  Os_StatusType OsStatus
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsProtectionPropagationRequired (
  Os_StatusType OsStatus
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsKillingEnabled (void);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsAssertEnabled (void);
...
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsServiceProtectionEnabled (void);
 ...
 **********************************************************************************************************************/
/* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ErrIsExtendedStatusEnabled (void);
 ...
 **********************************************************************************************************************/
void     Os_ErrApplicationError
(
  OSServiceIdType ServiceId,
  Os_StatusType Status,
  const   Os_ErrorParamsType OS_VAR_NOINIT * Parameters
);
 ...
 **********************************************************************************************************************/
void     Os_ErrProtectionError(Os_StatusType Fatalerror);
 ...
 *  \trace        CREQ-133061
 **********************************************************************************************************************/
void     Os_ErrProtectionException
(
  Os_StatusType Error,
  Os_AddressOfConstType ExceptionInstructionAddress,
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
AlarmType     Os_ErrorGetParameter_AlarmType
(
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
AlarmBaseRefType     Os_ErrorGetParameter_AlarmBaseRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
ApplicationStateRefType     Os_ErrorGetParameter_ApplicationStateRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
ApplicationType     Os_ErrorGetParameter_ApplicationType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
boolean     Os_ErrorGetParameter_boolean(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
OS_VAR_NOINIT boolean       * Os_ErrorGetParameter_booleanRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
CoreIdType     Os_ErrorGetParameter_CoreIdType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_ExceptionContextRefType     Os_ErrorGetParameter_ExceptionContextRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
CounterType     Os_ErrorGetParameter_CounterType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
EventMaskType     Os_ErrorGetParameter_EventMaskType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
EventMaskType*     Os_ErrorGetParameter_EventMaskRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
IdleModeType     Os_ErrorGetParameter_IdleModeType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
ISRType     Os_ErrorGetParameter_ISRType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
ResourceType     Os_ErrorGetParameter_ResourceType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_InterruptSourceIdRefType     Os_ErrorGetParameter_InterruptSourceIdRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_ExceptionSourceIdRefType     Os_ErrorGetParameter_ExceptionSourceIdRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
RestartType     Os_ErrorGetParameter_RestartType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
ScheduleTableStatusRefType     Os_ErrorGetParameter_ScheduleTableStatusRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
ScheduleTableType     Os_ErrorGetParameter_ScheduleTableType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
SpinlockIdType     Os_ErrorGetParameter_SpinlockIdType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TaskRefType     Os_ErrorGetParameter_TaskRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TaskStateRefType     Os_ErrorGetParameter_TaskStateRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_BarrierIdType     Os_ErrorGetParameter_BarrierIdType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TaskType     Os_ErrorGetParameter_TaskType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TickRefType     Os_ErrorGetParameter_TickRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TickType     Os_ErrorGetParameter_TickType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TrustedFunctionIndexType     Os_ErrorGetParameter_TrustedFunctionIndexType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TrustedFunctionParameterRefType     Os_ErrorGetParameter_TrustedFunctionParameterRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_FastTrustedFunctionIndexType     Os_ErrorGetParameter_FastTrustedFunctionIndexType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_FastTrustedFunctionParameterRefType     Os_ErrorGetParameter_FastTrustedFunctionParameterRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_NonTrustedFunctionIndexType     Os_ErrorGetParameter_Os_NonTrustedFunctionIndexType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
Os_NonTrustedFunctionParameterRefType     Os_ErrorGetParameter_Os_NonTrustedFunctionParameterRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
TryToGetSpinlockType const *     Os_ErrorGetParameter_TryToGetSpinlockRefType
(
  Os_ErrorParmIndexType ParamIndex
);
 ...
 *  \trace        CREQ-102
 **********************************************************************************************************************/
Os_StatusType     Os_Api_GetDetailedError(Os_ErrorInformationRefType ErrorRef);
 ...
 *  \trace        SPEC-67577
 **********************************************************************************************************************/
OSServiceIdType     Os_Api_ErrorGetServiceId
(
  void
);
