...
\CM CM_OS_FIFO08READ_DYN_M
      Verify that the Dyn pointer of each Os_Fifo08ReadConfigType object is a non ((void *)0).

\CM CM_OS_FIFO08WRITE_DYN_M
      Verify that the Dyn pointer of each Os_Fifo08WriteConfigType object is a non ((void *)0).

\CM CM_OS_FIFO08WRITE_DATA_M
      Verify that
        1. the Data pointer of each Os_Fifo08WriteConfigType object is a non ((void *)0).
