...
struct Os_Fifo08WriteConfigType_Tag
{
    Os_Fifo08WriteType OS_VAR_NOINIT * Dyn;        /*!< Pointer to the runtime write data. */
  const   Os_Fifo08ReadType OS_VAR_NOINIT * Read;      /*!< Pointer to the runtime read data. */
    Os_Fifo08NodeType OS_APPL_DATA * Data;         /*!< Pointer to the queue array. */
...
struct Os_Fifo08ReadConfigType_Tag
{
    Os_Fifo08ReadType OS_VAR_NOINIT * Dyn;         /*!< Pointer to the runtime read data. */
  const   Os_Fifo08WriteType OS_VAR_NOINIT * Write;    /*!< Pointer to the runtime write data. */
  const   Os_Fifo08NodeType OS_APPL_DATA * Data;       /*!< Pointer to the queue array. */
  Os_FifoIdxType Size;                                            /*!< The queue size. */
};
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Fifo08WriteInit (
  const   Os_Fifo08WriteConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Fifo08IndicesInRangeOnWrite (
  const   Os_Fifo08WriteConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_FifoWriteResultType   Os_Fifo08Enqueue (
  const   Os_Fifo08WriteConfigType OS_APPL_DATA * Fifo,
  uint8 Value
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_Fifo08IsFull (
  const   Os_Fifo08WriteConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Fifo08ReadInit (
  const   Os_Fifo08ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Fifo08IndicesInRangeOnRead (
  const   Os_Fifo08ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint8   Os_Fifo08Dequeue (
  const   Os_Fifo08ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_Fifo08IsEmpty (
  const   Os_Fifo08ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void OS_CONST Os_Fifo08EmptyQueue (
  const   Os_Fifo08ReadConfigType OS_APPL_DATA * Fifo
);
