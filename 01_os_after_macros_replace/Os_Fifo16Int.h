...
struct Os_Fifo16WriteConfigType_Tag
{
    Os_Fifo16WriteType OS_VAR_NOINIT * Dyn;        /*!< Pointer to the runtime write data. */
  const   Os_Fifo16ReadType OS_VAR_NOINIT * Read;      /*!< Pointer to the runtime read data. */
    Os_Fifo16NodeType OS_APPL_DATA * Data;         /*!< Pointer to the queue array. */
...
struct Os_Fifo16ReadConfigType_Tag
{
    Os_Fifo16ReadType OS_VAR_NOINIT * Dyn;         /*!< Pointer to the runtime read data. */
  const   Os_Fifo16WriteType OS_VAR_NOINIT * Write;    /*!< Pointer to the runtime write data. */
  const   Os_Fifo16NodeType OS_APPL_DATA * Data;       /*!< Pointer to the queue array. */
  Os_FifoIdxType Size;                                            /*!< The queue size. */
};
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Fifo16WriteInit (
  const   Os_Fifo16WriteConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Fifo16IndicesInRangeOnWrite (
  const   Os_Fifo16WriteConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_FifoWriteResultType   Os_Fifo16Enqueue (
  const   Os_Fifo16WriteConfigType OS_APPL_DATA * Fifo,
  uint16 Value
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_Fifo16IsFull (
  const   Os_Fifo16WriteConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Fifo16ReadInit (
  const   Os_Fifo16ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Fifo16IndicesInRangeOnRead (
  const   Os_Fifo16ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint16   Os_Fifo16Dequeue (
  const   Os_Fifo16ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_Fifo16IsEmpty (
  const   Os_Fifo16ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void OS_CONST Os_Fifo16EmptyQueue (
  const   Os_Fifo16ReadConfigType OS_APPL_DATA * Fifo
);
