...
\CM CM_OS_FIFO32READ_DYN_M
      Verify that the Dyn pointer of each Os_Fifo32ReadConfigType object is a non ((void *)0).

\CM CM_OS_FIFO32WRITE_DYN_M
      Verify that the Dyn pointer of each Os_Fifo32WriteConfigType object is a non ((void *)0).

\CM CM_OS_FIFO32WRITE_DATA_M
      Verify that
        1. the Data pointer of each Os_Fifo32WriteConfigType object is a non ((void *)0).
