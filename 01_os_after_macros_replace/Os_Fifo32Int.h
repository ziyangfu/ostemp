...
struct Os_Fifo32WriteConfigType_Tag
{
    Os_Fifo32WriteType OS_VAR_NOINIT * Dyn;       /*!< Pointer to the runtime write data. */
  const   Os_Fifo32ReadType OS_VAR_NOINIT * Read;     /*!< Pointer to the runtime read data. */
    Os_Fifo32NodeType OS_APPL_DATA * Data;         /*!< Pointer to the queue array. */
...
struct Os_Fifo32ReadConfigType_Tag
{
    Os_Fifo32ReadType OS_VAR_NOINIT * Dyn;        /*!< Pointer to the runtime read data. */
  const   Os_Fifo32WriteType OS_VAR_NOINIT * Write;   /*!< Pointer to the runtime write data. */
  const   Os_Fifo32NodeType OS_APPL_DATA * Data;       /*!< Pointer to the queue array. */
  Os_FifoIdxType Size;                                            /*!< The queue size. */
};
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Fifo32WriteInit (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Fifo32ReadInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint32   Os_Fifo32Dequeue (
  const   Os_Fifo32ReadConfigType OS_APPL_DATA * Fifo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void OS_CONST Os_Fifo32EmptyQueue (
  const   Os_Fifo32ReadConfigType OS_APPL_DATA * Fifo
);
