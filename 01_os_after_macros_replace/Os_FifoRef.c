...
\CM CM_OS_FIFOREF_WRITECBK_DATA_M
      Verify that the WriteCallback of each Os_FifoRefWriteConfigType instance is a non ((void *)0).

\CM CM_OS_FIFOREF_READCBK_DATA_M
      Verify that the ReadCallback of each Os_FifoRefReadConfigType instance is a non ((void *)0).
 */
