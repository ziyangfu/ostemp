 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextInit (
  const   Os_Hal_ContextConfigType OS_CONST * Config,
 ...
 *  \pre          Config and Context parameter belong together.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextReset (
  const   Os_Hal_ContextConfigType OS_CONST * Config,
    Os_Hal_ContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextSetParameter (
    Os_Hal_ContextType OS_VAR_NOINIT * Context,
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextSetStack (
    Os_Hal_ContextType OS_VAR_NOINIT * Context,
  const   Os_Hal_ContextStackConfigType OS_VAR_NOINIT * Stack
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextGetStack (
  const   Os_Hal_ContextConfigType OS_CONST * Context,
    Os_Hal_ContextStackConfigType OS_VAR_NOINIT * Stack
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextSetInterruptState (
    Os_Hal_ContextType OS_VAR_NOINIT * Context,
 ...
 *  \pre             Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextSetUserMsrBits (
    Os_Hal_ContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextFirstResume (
 ...
 *  \pre          Config and Context parameter belong together.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextResetAndResume (
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextAbort (
  const   Os_Hal_ContextConfigType OS_CONST * Config,
    Os_Hal_ContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Interrupts locked to TP lock level.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextReturn (
  const   Os_Hal_ContextType OS_VAR_NOINIT * Current,
  const   Os_Hal_ContextType OS_VAR_NOINIT * Next
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_ContextIsExceptionContextReadingSupported (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_ContextIsExceptionContextModificationSupported (
  void
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextIntCleanupCSAs (
  const   Os_Hal_ContextType OS_VAR_NOINIT * Context,
  const   Os_Hal_IntGlobalStateType OS_CONST * PreviousGlobalIntState
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextIntPrepareCSAContent (
  const   Os_Hal_ContextConfigType OS_CONST * CurrentConfig,
    Os_Hal_ContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextIntInitialize (
  const   Os_Hal_ContextConfigType OS_CONST * CurrentConfig,
    Os_Hal_ContextType OS_VAR_NOINIT * Context,
  const   Os_Hal_IntGlobalStateType OS_CONST * PreviousGlobalIntState
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextIntInitializeReserved (
  const   Os_Hal_ContextConfigType OS_CONST * CurrentConfig,
    Os_Hal_ContextType OS_VAR_NOINIT * Context,
  const   Os_Hal_IntGlobalStateType OS_CONST * PreviousGlobalIntState
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextIntSave (
    Os_Hal_ContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Concurrent access to given data shall be prevented.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextIntRestore (
  const   Os_Hal_ContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Interrupts locked to TP lock level.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextFetchInitialFpuContext (
    Os_Hal_ContextFpuContextType OS_VAR_NOINIT * InitialContext
);
 ...
 *  \pre          Interrupts locked to TP lock level.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextInitFpu (
  const   Os_Hal_ContextFpuContextType OS_VAR_NOINIT * InitialContext
);
 ...
 *  \pre          Interrupts locked to TP lock level.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextInitFpuContext (
    Os_Hal_ContextFpuContextType OS_VAR_NOINIT * Context,
  const   Os_Hal_ContextFpuContextType OS_VAR_NOINIT * InitialContext
);
 ...
 *  \pre          Interrupts locked to TP lock level.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextStoreFpuContext (
    Os_Hal_ContextFpuContextType OS_VAR_NOINIT * Context
);
 ...
 *  \pre          Interrupts locked to TP lock level.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ContextRestoreFpuContext (
  const   Os_Hal_ContextFpuContextType OS_VAR_NOINIT * Context
);
