...
void     Os_Hal_CoreInit(const   Os_Hal_CoreAsrConfigType OS_CONST * Config)
{
 ...
 **********************************************************************************************************************/
void     Os_Hal_CoreInitHardware(const   Os_Hal_SystemConfigType OS_CONST * Config)
{
  OS_IGNORE_UNREF_PARAM(Config);                                                                                        /* PRQA S 3112 */ /* MD_MSR_DummyStmt */
}
 ...
 *  Os_Hal_CoreFreeze()
 **********************************************************************************************************************/
OS_NORETURN void   Os_Hal_CoreFreeze /* COV_OS_HALCOREFREEZE */
(
  void
)
{
