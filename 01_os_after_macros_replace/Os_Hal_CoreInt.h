...
{
    Os_Hal_Core2ThreadType OS_VAR_NOINIT_FAST * Core2Thread[OS_CFG_COREPHYSICALID_COUNT];
};

/*! XSignal interrupt configuration. */
struct Os_Hal_XSigInterruptConfigType_Tag
{
  const   Os_Hal_IntIsrConfigType OS_CONST * ConfigData;
};
 ...
 *  \trace        CREQ-1201
 **********************************************************************************************************************/
void     Os_Hal_CoreInit
(
  const   Os_Hal_CoreAsrConfigType OS_CONST * Config
);
 ...
 *  \trace        CREQ-1201
 **********************************************************************************************************************/
void     Os_Hal_CoreInitHardware
(
  const   Os_Hal_SystemConfigType OS_CONST * Config
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_CoreIsThreadPointerUserReadable (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_CoreIsCoreIdUserReadable (
  void
);
 ...
 *  \pre          Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_CoreSetThread (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ThreadConfigType OS_CONST *   Os_Hal_CoreGetThread (
  const   Os_Hal_Core2ThreadConfigType OS_CONST * Core2Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_CoreIsPrivilegedModeUserReadable (
  void
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_CoreGetPrivilegedMode (
  void
);
 ...
 *  \pre          Privileged mode can be read in user mode or supervisor mode is active.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline boolean   Os_Hal_CoreGetPrivilegedModeFromPcxi (
  uint32 Param
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint8   Os_Hal_CountLeadingZeros (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_Hal_StackType OS_VAR_NOINIT *   Os_Hal_StackEndGet (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_Hal_StackType OS_VAR_NOINIT *   Os_Hal_StackBottomGet (
    Os_Hal_StackType OS_VAR_NOINIT * LowAddress,
    Os_Hal_StackType OS_VAR_NOINIT * HighAddress
);
 ...
 *********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_Hal_StackType OS_VAR_NOINIT *   Os_Hal_StackTopGet (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_Hal_StackType OS_VAR_NOINIT *   Os_Hal_StackPointerMoveDown (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint32   Os_Hal_StackCalculateUsage (
 ...
 *  \pre          Supervisor mode.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_CoreStart (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_SpinInit (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_Hal_SpinIsLocked (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_Hal_SpinlockResultType   Os_Hal_SpinTryLock (
    volatile Os_Hal_SpinlockType OS_VAR_NOINIT * Spinlock
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_SpinUnlock (
    volatile Os_Hal_SpinlockType OS_VAR_NOINIT * Spinlock
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_XSigInit (
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_XSigTrigger (
  const   Os_Hal_XSigInterruptConfigType OS_CONST * XSigConfig
);
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_XSigAcknowledge (
  const   Os_Hal_XSigInterruptConfigType OS_CONST * XSigConfig
);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_CoreIdle (void);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_CoreNop (void);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_NORETURN void   Os_Hal_CoreFreeze (void);
