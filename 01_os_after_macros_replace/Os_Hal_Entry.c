 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_Exception_Save_Context (
 ...
 **********************************************************************************************************************/
 OS_ALWAYS_INLINE static inline void   Os_Hal_Exception_Resume_Context (
  uint32 Pcxi
);
...
)
{
  ...
  if(context == ((void *)0))                                                                                               /* COV_OS_HALINVSTATE */
  {
    Os_ErrKernelPanic();
  }
  else
 ...
 *
 */
OS_HAL_NOINLINE void   Os_Hal_UnhandledExc (
  Os_ExceptionSourceIdType ExceptionSource,
  uint32 Pcxi,
...
)
{
  ...
  if (ptrToExceptionContext == ((void *)0))                                                                                /* COV_OS_HALINVSTATE */
  {
    Os_ErrKernelPanic();
  }
  else
 ...
 *
 */
OS_HAL_NOINLINE void   Os_Hal_MemFault (
  Os_ExceptionSourceIdType ExceptionSource,
  uint32 Pcxi,
  Os_AddressOfConstType ExceptionAddress,
  uint32 SavedMpuRegionForStackLow,
 ...
 *
 */
OS_HAL_NOINLINE uint32   Os_Hal_SysCall (
  uint32 Tin,
  uint32 Pcxi,
 ...
 *
 */
OS_HAL_NOINLINE void   Os_Hal_IsrRun (
 ...
 *
 */
OS_HAL_NOINLINE void   Os_Hal_UnhandledIrq (
