 ...
 *
 */
OS_ALWAYS_INLINE static inline Os_Hal_IntGlobalStateType   /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   /* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_Hal_IntDisableSourceMapped (
  const   Os_Hal_IntIsrConfigType OS_APPL_DATA * IsrConfig,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   /* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_Hal_IntIsInterruptSourceEnabledMapped (
  const   Os_Hal_IntIsrConfigType OS_APPL_DATA * IsrConfig,
  const   Os_Hal_IntIsrMapConfigType OS_APPL_DATA * IsrMapConfig
)                                                                                                                      /* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */
 ...
 **********************************************************************************************************************/
/* COV_OS_HALPLATFORMISRMAPPINGAVAILABILITY */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   /* COV_OS_HALPLATFORMISRPOSTACTIONAVAILABILITY */ /* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
Os_Hal_IntPostAction (
  const   Os_Hal_IntIsrConfigType OS_APPL_DATA * IsrConfig
