...
struct Os_Hal_MpCoreConfigType_Tag
{
  ...
  const   Os_Hal_MpuRegionRangeConfigType OS_CONST * MpuDataRegions;
  ...
  const   Os_Hal_MpuRegionRangeConfigType OS_CONST * MpuCodeRegions;
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_MpSystemInit (
  const   Os_Hal_MpSystemConfigType OS_CONST * SystemConfig
);
 ...
 *  \pre            Supervisor mode.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_MpCoreInit (
  const   Os_Hal_MpCoreConfigType OS_CONST * CoreConfig,
  const   Os_Hal_ContextStackConfigType OS_CONST * InitialStackRegion
);
 ...
 *  \pre            Supervisor mode.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_MpAppSwitch (
  const   Os_Hal_MpAppConfigType OS_CONST * AppConfig
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_MpThreadSwitch (
  const   Os_Hal_MpThreadConfigType OS_CONST * ThreadConfig
);
 ...
 *  \pre            Supervisor mode.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ProgramDataRegions (
  uint8 StartSlot,
  uint8 Count,
  const   Os_Hal_MpuRegionRangeConfigType OS_CONST * RegionsConfig
);
 ...
 *  \pre            Supervisor mode.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_ProgramCodeRegions (
  uint8 StartSlot,
  uint8 Count,
  const   Os_Hal_MpuRegionRangeConfigType OS_CONST * RegionsConfig
);
