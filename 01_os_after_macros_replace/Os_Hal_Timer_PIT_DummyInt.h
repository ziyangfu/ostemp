 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_TimerPitInit (
  const   Os_Hal_TimerPitConfigType OS_CONST * TimerConfig
);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_TimerPitAckAndReload (
  const   Os_Hal_TimerPitConfigType OS_CONST * TimerConfig
);
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint32   Os_Hal_TimerPitIsPending (
  const   Os_Hal_TimerPitConfigType OS_CONST * TimerConfig
);
