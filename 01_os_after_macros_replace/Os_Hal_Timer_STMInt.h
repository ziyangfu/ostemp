 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_TimerFrtInit (
 ...
 *  \trace          SPEC-63797
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_Hal_TimerFrtTickType   Os_Hal_TimerFrtGetCounterValue (
  const   Os_Hal_TimerFrtConfigType OS_CONST * TimerConfig
);
 ...
 *  \trace          SPEC-63797
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_TimerFrtSetCompareValue (
  const   Os_Hal_TimerFrtConfigType OS_CONST * TimerConfig,
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_TimerFrtAcknowledge (
  const   Os_Hal_TimerFrtConfigType OS_CONST * TimerConfig
);
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Hal_TimerFrtTriggerIrq (
  const   Os_Hal_TimerFrtConfigType OS_CONST * TimerConfig
);
