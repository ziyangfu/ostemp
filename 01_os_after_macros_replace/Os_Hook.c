 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_HookType OS_VAR_NOINIT *   Os_HookGetDyn (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_HookIsNestingAllowed (
    const   Os_HookInfoType OS_VAR_NOINIT * CurrentHookStatus,
    const   Os_HookConfigType OS_CONST *    HookToBeNested
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_HookIsPanicHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_HookIsStatusHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_HookIsStartupHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_HookIsCallbackEnabled ( void );
 ...
 **********************************************************************************************************************/
OS_NORETURN static inline void   Os_HookReturnWithSchedule (void);
 ...
 *  \pre            Concurrent access is prevented by caller.
 **********************************************************************************************************************/
OS_NORETURN static inline void   Os_HookReturnWithoutSchedule (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_HookCall (
  const   Os_HookConfigType OS_CONST * Hook
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_HookStatusHookConfigType OS_CONST *   Os_Hook2StatusHook (
  const   Os_HookConfigType OS_CONST * Hook
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_HookProtectionHookConfigType OS_CONST *   Os_Hook2ProtectionHook (
  const   Os_HookConfigType OS_CONST * Hook
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_HookInitHookConfigType OS_CONST *   Os_Hook2InitHook (
  const   Os_HookConfigType OS_CONST * Hook
);
...
{
  const   Os_HookConfigType OS_CONST * currentHook;
    Os_HookInfoType OS_VAR_NOINIT * activeHooks;
 ...
 *
 */
OS_NORETURN static inline void   Os_HookReturnWithSchedule (
  void
)
{
  const   Os_ThreadConfigType OS_CONST * currentThread;
  const   Os_ThreadConfigType OS_CONST * previousThread;
...
)
{
  ...
  const   Os_CoreAsrConfigType OS_CONST * localCore;
    Os_IntApiStateType OS_VAR_NOINIT * intApiStateRef;
    Os_HookInfoType OS_VAR_NOINIT * activeHooks;
...
)
{
  ...
  if( (Hook != ((void *)0)) && (Hook->HookTypeFlag != OS_HOOKFLAG_INITHOOK) )
  {
...
)
{
  ...
  if(OS_UNLIKELY(Hook == ((void *)0)))                                                                                     /* COV_OS_INVSTATE */
  {
    /* #20 Kernel panic. */
    Os_ErrKernelPanic();
  }
  ...
  {
    const   Os_ThreadConfigType OS_CONST * hookThread;
      Os_HookType OS_VAR_NOINIT * hookDyn;
...
)
{
  ...
  else
  {
    ...
    const   Os_HookConfigType OS_CONST * hook;
      Os_HookType OS_VAR_NOINIT * hookDyn;
    const   Os_HookProtectionHookConfigType OS_CONST * protectionHook;
...
)
{
  ...
  {
    if(Hook != ((void *)0))                                                                                                /* COV_OS_INVSTATE */
    {
...
)
{
  ...
  if(Os_HookIsCallbackEnabled() != 0u)                                                                                  /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
  {
    if(Hook != ((void *)0))
    {
      const   Os_ThreadConfigType OS_CONST * targetThread;
...
{
  return  (const   Os_HookStatusHookConfigType OS_CONST *)(Hook);                                            /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return  (const   Os_HookProtectionHookConfigType OS_CONST *)(Hook);                                        /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return  (const   Os_HookInitHookConfigType OS_CONST *)(Hook);                                              /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (  Os_HookType OS_VAR_NOINIT *)Hook->Thread.Dyn;                                                /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
\CM CM_OS_HOOK_PROTECTIONHOOK_CALLBACK_M
      Verify that the callback pointer of each Os_HookProtectionHookConfigType object is a non ((void *)0).

\CM CM_OS_HOOK_CALLBACK_CALLBACK_M
      Verify that the callback pointer of each Os_HookCallbackType object is a non ((void *)0).

\CM CM_OS_HOOK_INITHOOK_CALLBACK_M
      Verify that the callback pointer of each Os_HookInitHookConfigType object is a non ((void *)0).
...
\CM CM_OS_HOOKID2HOOK_M
      Verify that:
        1. each entry in OsCfg_HookRefs except the last is no ((void *)0) and
