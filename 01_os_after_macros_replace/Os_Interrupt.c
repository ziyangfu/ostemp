 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_InterruptCheckNotInCriticalSection (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_InterruptDisableAllEnter (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_InterruptDisableAllExit (
    Os_IntApiStateType OS_VAR_NOINIT * InterruptState
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_InterruptCheckInDisableAll (
  const   Os_IntApiStateType OS_VAR_NOINIT * InterruptState
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_InterruptCheckNotInDisableAll (
  const   Os_IntApiStateType OS_VAR_NOINIT * InterruptState
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_InterruptCheckNoOverflow (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_InterruptTakeSnapshot (
    Os_IntApiCntType OS_VAR_NOINIT * Snapshot,
  Os_IntApiCntType Counter
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_InterruptCheckSnapshot (
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IntSuspendCat1 (
    Os_IntStateType OS_APPL_DATA * Cat1State
);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IntResumeCat1 (
  const   Os_IntStateType OS_APPL_DATA * Cat1State
);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IntSuspendCat2 (
    Os_IntStateType OS_APPL_DATA * State
);
 ...
 *  \pre            Supervisor mode
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IntResumeCat2 (
  const   Os_IntStateType OS_APPL_DATA * Cat2State
);
 ...
 *
 */
void     Os_Api_DisableAllInterrupts
(
  void
)
{
  ...
  if(Os_CoreIsInterruptOnlyOs() == 0u )                                                                                 /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    ...
    const   Os_ThreadConfigType OS_CONST * caller;
      Os_IntApiStateType OS_VAR_NOINIT * interruptApiState;
 ...
 * */
  ...
  {
    /* #70 Otherwise, call the HAL API directly. */
 ...
 *
 */
void     Os_Api_EnableAllInterrupts
(
  void
)
{
 ...
 *
 */
void     Os_Api_SuspendAllInterrupts
(
  void
)
{
 ...
 *
 */
void     Os_Api_ResumeAllInterrupts
(
  void
)
{
 ...
 *
 */
void     Os_Api_SuspendOSInterrupts
(
  void
)
{
 ...
 *
 */
void     Os_Api_ResumeOSInterrupts
(
  void
)
{
