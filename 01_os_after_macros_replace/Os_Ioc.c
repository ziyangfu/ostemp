 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocMultiReceiveInit (
  const   Os_IocMultiReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_IocChannelIsEnabled (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocCloseChannel (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocReceiveInit (
  const   Os_IocReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocReceiveCloseChannel (
  const   Os_IocReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocSendInit (
  const   Os_IocSendConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocSendCloseChannel (
  const   Os_IocSendConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_IocMultiReceiveType volatile OS_VAR_NOINIT *   Os_IocMultiReceiveGetDyn (
  const   Os_IocMultiReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_IocReceiveType volatile OS_VAR_NOINIT *   Os_IocReceiveGetDyn (
  const   Os_IocReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_IocSendType volatile OS_VAR_NOINIT *   Os_IocSendGetDyn (
  const   Os_IocSendConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocLock (
  const   Os_IocConfigType OS_CONST * Ioc,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocUnlock (
  const   Os_IocConfigType OS_CONST * Ioc,
  const   Os_IntStateType   * InterruptState
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Std_ReturnType   Os_IocCallCallbacks (
  const   Os_IocCallbacksConfigType OS_CONST * Callbacks
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_IocCheckNoDataLost (
  const   Os_IocReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocIncrementLostCounter (
  const   Os_IocSendConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc08ReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc08MultiReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc08SendInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_IocInternalReturnType   Os_Ioc08ReceiveInternal (
  const   Os_Ioc08ReceiveConfigType OS_CONST * Ioc,
    uint8   * Data
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc16ReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc16MultiReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc16SendInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_IocInternalReturnType   Os_Ioc16ReceiveInternal (
  const   Os_Ioc16ReceiveConfigType OS_CONST * Ioc,
    uint16   * Data
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc32ReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc32MultiReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_Ioc32SendInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_IocInternalReturnType   Os_Ioc32ReceiveInternal (
  const   Os_Ioc32ReceiveConfigType OS_CONST * Ioc,
    uint32   * Data
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocRefReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocRefMultiReceiveInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocRefSendInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_IocInternalReturnType   Os_IocRefReceiveInternal (
  const   Os_IocRefReceiveConfigType OS_CONST * Ioc,
    void   * Data
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocWriteInit (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_Ioc08MultiReceiveConfigType OS_CONST *   Os_IocIoc2Ioc08MultiReceive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_Ioc16MultiReceiveConfigType OS_CONST *   Os_IocIoc2Ioc16MultiReceive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_Ioc32MultiReceiveConfigType OS_CONST *   Os_IocIoc2Ioc32MultiReceive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_IocRefMultiReceiveConfigType OS_CONST *   Os_IocIoc2IocRefMultiReceive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_IocWriteConfigType OS_CONST *   Os_IocIoc2IocWrite (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Ioc08ReceiveConfigType OS_CONST *   Os_IocIoc2Ioc08Receive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Ioc16ReceiveConfigType OS_CONST *   Os_IocIoc2Ioc16Receive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Ioc32ReceiveConfigType OS_CONST *   Os_IocIoc2Ioc32Receive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_IocRefReceiveConfigType OS_CONST *   Os_IocIoc2IocRefReceive (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Ioc08SendConfigType OS_CONST *   Os_IocIoc2Ioc08Send (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Ioc16SendConfigType OS_CONST *   Os_IocIoc2Ioc16Send (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Ioc32SendConfigType OS_CONST *   Os_IocIoc2Ioc32Send (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_IocRefSendConfigType OS_CONST *   Os_IocIoc2IocRefSend (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocInitBase (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 *  \pre        -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Std_ReturnType   Os_IocEmptyMultiQueue (
  const   Os_IocMultiReceiveConfigType OS_CONST * Ioc,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_AppAccessMaskType   Os_IocGetAccessingApplications (
  const   Os_IocConfigType OS_CONST * Ioc
);
 ...
 */
OS_ALWAYS_INLINE 
static inline const   Os_IocWriteConfigType OS_CONST *   Os_IocIoc2IocWrite (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  /* #10 Perform cast on given pointer. */
  return (const   Os_IocWriteConfigType OS_CONST *)Ioc;                                                      /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 */
OS_ALWAYS_INLINE 
static inline const   Os_Ioc08ReceiveConfigType OS_CONST *   Os_IocIoc2Ioc08Receive (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  /* #10 Perform cast on given pointer. */
  return (const   Os_Ioc08ReceiveConfigType OS_CONST *)Ioc;                                                  /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 */
OS_ALWAYS_INLINE 
static inline const   Os_Ioc16ReceiveConfigType OS_CONST *   Os_IocIoc2Ioc16Receive (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  /* #10 Perform cast on given pointer. */
  return (const   Os_Ioc16ReceiveConfigType OS_CONST *)Ioc;                                                  /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 */
OS_ALWAYS_INLINE 
static inline const   Os_Ioc32ReceiveConfigType OS_CONST *   Os_IocIoc2Ioc32Receive (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  /* #10 Perform cast on given pointer. */
  return (const   Os_Ioc32ReceiveConfigType OS_CONST *)Ioc;                                                  /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 */
OS_ALWAYS_INLINE 
static inline const   Os_IocRefReceiveConfigType OS_CONST *   Os_IocIoc2IocRefReceive (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  /* #10 Perform cast on given pointer. */
  return (const   Os_IocRefReceiveConfigType OS_CONST *)Ioc;                                                 /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_Ioc08MultiReceiveConfigType OS_CONST *)Ioc;                                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_Ioc16MultiReceiveConfigType OS_CONST *)Ioc;                                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_Ioc32MultiReceiveConfigType OS_CONST *)Ioc;                                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (const   Os_IocRefMultiReceiveConfigType OS_CONST *)Ioc;                                            /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_Ioc08SendConfigType OS_CONST *   Os_IocIoc2Ioc08Send (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  return (const   Os_Ioc08SendConfigType OS_CONST *)Ioc;                                                     /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_Ioc16SendConfigType OS_CONST *   Os_IocIoc2Ioc16Send (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  return (const   Os_Ioc16SendConfigType OS_CONST *)Ioc;                                                     /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_Ioc32SendConfigType OS_CONST *   Os_IocIoc2Ioc32Send (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  return (const   Os_Ioc32SendConfigType OS_CONST *)Ioc;                                                     /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_IocRefSendConfigType OS_CONST *   Os_IocIoc2IocRefSend (
  const   Os_IocConfigType OS_CONST * Ioc
)
{
  return (const   Os_IocRefSendConfigType OS_CONST *)Ioc;                                                    /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_IocCloseChannel /* COV_OS_INVSTATE */
(
  const   Os_IocConfigType OS_CONST * Ioc
)                                                                                                                      /* COV_OS_INVSTATE */
{
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_IocReceiveCloseChannel /* COV_OS_INVSTATE */
(
  const   Os_IocReceiveConfigType OS_CONST * Ioc
)                                                                                                                      /* COV_OS_INVSTATE */
{
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_IocSendCloseChannel /* COV_OS_INVSTATE */
(
  const   Os_IocSendConfigType OS_CONST * Ioc
)                                                                                                                      /* COV_OS_INVSTATE */
{
...
{
  return (  Os_IocMultiReceiveType volatile OS_VAR_NOINIT *)(Ioc->Base.Dyn);                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (  Os_IocReceiveType volatile OS_VAR_NOINIT *)(Ioc->Base.Dyn);                                  /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (  Os_IocSendType volatile OS_VAR_NOINIT *)(Ioc->Base.Dyn);                                     /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
    Os_IocReceiveType volatile   * receiverDyn;
  const   Os_IocSendType volatile   * senderDyn;
 ...
 *
 */
Std_ReturnType     Os_Ioc08MultiReceive
(
  const   Os_Ioc08MultiReceiveConfigType OS_CONST * Ioc,
    uint8   * Data
)
{
...

  {
    ...
    else
    {
      ...
      {
          Os_IocMultiReceiveType volatile   * dyn;
 ...
 *
 */
Std_ReturnType     Os_Ioc08Receive
(
  const   Os_Ioc08ReceiveConfigType OS_CONST * Ioc,
    uint8   * Data
)
 ...
 *
 */
Std_ReturnType     Os_Ioc08EmptyQueue
(
  const   Os_Ioc08ReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_Ioc08EmptyMultiQueue                                                                   /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  const   Os_Ioc08MultiReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_Ioc16MultiReceive
(
  const   Os_Ioc16MultiReceiveConfigType OS_CONST * Ioc,
    uint16   * Data
)
{
...

  {
    ...
    else
    {
      ...
      {
          Os_IocMultiReceiveType volatile OS_VAR_NOINIT * dyn;
        Os_ObjIdx_IteratorType receiveChannelCounter;
 ...
 *
 */
Std_ReturnType     Os_Ioc16EmptyMultiQueue                                                                   /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  const   Os_Ioc16MultiReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_Ioc16Receive
(
  const   Os_Ioc16ReceiveConfigType OS_CONST * Ioc,
    uint16   * Data
)
 ...
 *
 */
Std_ReturnType     Os_Ioc16EmptyQueue
(
  const   Os_Ioc16ReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_Ioc32MultiReceive
(
  const   Os_Ioc32MultiReceiveConfigType OS_CONST * Ioc,
    uint32   * Data
)
 ...
 *
 */
Std_ReturnType     Os_Ioc32Receive
(
  const   Os_Ioc32ReceiveConfigType OS_CONST * Ioc,
    uint32   * Data
)
 ...
 *
 */
Std_ReturnType     Os_Ioc32EmptyQueue
(
  const   Os_Ioc32ReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_Ioc32EmptyMultiQueue                                                                   /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  const   Os_Ioc32MultiReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_IocRefMultiReceive
(
  const   Os_IocRefMultiReceiveConfigType OS_CONST * Ioc,
    void   * Data
)
 ...
 *
 */
Std_ReturnType     Os_IocRefReceive
(
  const   Os_IocRefReceiveConfigType OS_CONST * Ioc,
    void   * Data
)
 ...
 *
 */
Std_ReturnType     Os_IocRefEmptyQueue
(
  const   Os_IocRefReceiveConfigType OS_CONST * Ioc
)
{
 ...
 *
 */
Std_ReturnType     Os_IocRefEmptyMultiQueue                                                                  /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  const   Os_IocRefMultiReceiveConfigType OS_CONST * Ioc
)
{
...
\CM CM_OS_IOCRECEIVE_SEND_M
      Verify that the Send pointer of each Os_IocReceiveConfigType object is initialized with no ((void *)0).

\CM CM_OS_IOCSEND_RECEIVE_M
      Verify that the Receive pointer of each Os_IocSendConfigType object is initialized with no ((void *)0).

\CM CM_OS_IOC_CALLBACK_R
      Runtime check ensures, that the passed callback is a non ((void *)0).

\CM CM_OS_IOC08MULTIRECEIVE_RECEIVERS_M
      Verify that:
        1. Verify that each Os_Ioc08MultiReceiveConfigType object's Receivers pointer is no ((void *)0),
        2. that the size of the Reveivers array equals the ReceiveChannelCount.

\CM CM_OS_IOC16MULTIRECEIVE_RECEIVERS_M
      Verify that:
        1. Verify that each Os_Ioc16MultiReceiveConfigType object's Receivers pointer is no ((void *)0),
        2. that the size of the Reveivers array equals the ReceiveChannelCount.

\CM CM_OS_IOC32MULTIRECEIVE_RECEIVERS_M
      Verify that:
        1. Verify that each Os_Ioc32MultiReceiveConfigType object's Receivers pointer is no ((void *)0),
        2. that the size of the Reveivers array equals the ReceiveChannelCount.

\CM CM_OS_IOCREFMULTIRECEIVE_RECEIVERS_M
      Verify that:
        1. Verify that each Os_IocRefMultiReceiveConfigType object's Receivers pointer is no ((void *)0),
        2. that the size of the Reveivers array equals the ReceiveChannelCount.
...
\CM CM_OS_IOC_SPINLOCK_M
      ...
      OS_IOCLOCKMODE_ALL, is no ((void *)0).

\CM CM_OS_IOCWRITE_COPYCBK_M
      Verify that the CopyCbk pointer of each Os_IocWriteConfigType object is initialized with a non ((void *)0).

\CM CM_OS_IOCREAD_COPYCBK_M
      Verify that the CopyCbk pointer of each Os_IocReadConfigType object is initialized with a non ((void *)0).

\CM CM_OS_IOCWRITE_INITCBK_R
      Implementation ensures, that InitCbk is a non ((void *)0).

\CM CM_OS_IOCWRITE_DATA_M
      Verify that the Data pointer of each Os_IocWriteConfigType object is initialized with a non ((void *)0).

\CM CM_OS_IOCREAD_DATA_M
      Verify that the Data pointer of each Os_IocReadConfigType object is initialized with a non ((void *)0).

\CM CM_OS_IOCCALLBACKSCONFIG_CALLBACKREFS_01_02_M
      Verify that
       1. the callback list of each Os_IocCallbacksConfigType object is a non ((void *)0) if the callback count as not
          zero
