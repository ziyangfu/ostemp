...
typedef const   Os_HookCallbackConfigType OS_CONST * Os_IocCallbackConfigRefType;

/*! The static data of a IOC callback. */
struct Os_IocCallbacksConfigType_Tag
{
  /*! The callbacks which are provided by the receivers. */
  const   Os_IocCallbackConfigRefType OS_CONST * CallbackRefs;
...
struct Os_IocConfigType_Tag
{
   ...
   * \details If this pointer is a ((void *)0), no spinlock is used. */
...
struct Os_IocReceiveConfigType_Tag
{
  ...
  const   Os_IocSendConfigType   * Send;
};
...
struct Os_IocSendConfigType_Tag
{
  ...
  const   Os_IocReceiveConfigType   * Receive;
};
...
struct Os_Ioc08MultiReceiveConfigType_Tag
{
  ...
  /*! Generic data. */
  const   Os_Ioc08ReceiveConfigType   * Receivers;
};
...
struct Os_Ioc16MultiReceiveConfigType_Tag
{
  ...
  /*! Generic data. */
  const   Os_Ioc16ReceiveConfigType   * Receivers;
};
...
struct Os_Ioc32MultiReceiveConfigType_Tag
{
  ...
  /*! Generic data. */
  const   Os_Ioc32ReceiveConfigType   * Receivers;
};
...
struct Os_IocRefMultiReceiveConfigType_Tag
{
  ...
  /*! Generic data. */
  const   Os_IocRefReceiveConfigType   * Receivers;
};
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IocInit (
 ...
 *  \synchronous  TRUE
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_IocHasCallbacks (
  void
);
 ...
 *  \trace          SPEC-63578, SPEC-63673, SPEC-63566
 **********************************************************************************************************************/
Std_ReturnType     Os_Ioc08EmptyMultiQueue
(
  const   Os_Ioc08MultiReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \trace          SPEC-63578, SPEC-63566, SPEC-63573
 **********************************************************************************************************************/
Std_ReturnType     Os_Ioc16EmptyMultiQueue
(
  const   Os_Ioc16MultiReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \trace          SPEC-63578, SPEC-63566, SPEC-63573
 **********************************************************************************************************************/
Std_ReturnType     Os_Ioc32EmptyMultiQueue
(
  const   Os_Ioc32MultiReceiveConfigType OS_CONST * Ioc
);
 ...
 *  \trace          SPEC-63578, SPEC-63566, SPEC-63573
 **********************************************************************************************************************/
Std_ReturnType     Os_IocRefEmptyMultiQueue
(
  const   Os_IocRefMultiReceiveConfigType OS_CONST * Ioc
);
