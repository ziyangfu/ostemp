...
struct Os_IsrHwConfigType_Tag
{
  ...
  const   Os_Hal_IntIsrConfigType OS_CONST * HwConfig;

  /*! Hardware specific ISR mapping configuration. */
  const   Os_Hal_IntIsrMapConfigType OS_CONST * MapConfig;
...
struct Os_IsrConfigType_Tag
{
  ...
  * This attribute must come first! */
  ...
  /*! Hardware specific ISR configuration. */
  const   Os_IsrHwConfigType OS_CONST * SourceConfig;
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_IsrConfigType OS_CONST *   Os_IsrThread2Isr (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_IsrConfigType OS_CONST *   Os_IsrId2Isr (
  ISRType IsrId
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IsrHalIntLevel2CoreIntLevel (
 ...
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_IsrSuicide (void);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IsrDisable (
  const   Os_IsrConfigType OS_CONST * Isr
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IsrCat1Disable (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IsrDisableSource (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IsrInterruptSourceInit (
  const   Os_IsrHwConfigType OS_CONST * Isr
);
 ...
 *  \trace        SPEC-63796, SPEC-63785, SPEC-63881, SPEC-64061
 **********************************************************************************************************************/
OS_NORETURN void   Os_IsrEpilogueTp (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_IsrLevelIsLe (
  const   Os_IsrConfigType OS_CONST * Isr,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ThreadConfigType OS_CONST *   Os_IsrGetThread (
  const   Os_IsrConfigType OS_CONST * Isr
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AccessCheckConfigType OS_CONST *   Os_IsrGetAccessRights (
  const   Os_IsrConfigType OS_CONST * Isr
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_IsrClearPending (
  const   Os_IsrHwConfigType OS_CONST * Isr
);
 ...
 *  \trace          CREQ-114872
 **********************************************************************************************************************/
Os_StatusType     Os_Api_IsInterruptSourceEnabled(ISRType ISRID,
 ...
 *  \trace          CREQ-114873
 **********************************************************************************************************************/
Os_StatusType     Os_Api_IsInterruptPending(ISRType ISRID,
