...
#define OS_LOCK_LIST_END            ((const   Os_LockConfigType OS_CONST *)(((void *)0)))

/*! Link value, if the lock is not part of a list/occupied. */
#define OS_LOCK_NOT_LINKED          ((const   Os_LockConfigType OS_CONST *)(~((Os_Hal_AddressType)0)))
...
struct Os_LockType_Tag
{
  ...
  const   Os_LockConfigType OS_CONST * Next;
};
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_LockListDelete (
    Os_LockListType OS_VAR_NOINIT * LockList,
  const   Os_LockConfigType OS_CONST * Lock
);
 ...
 *  \retval         ((void *)0)  If list is empty.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_LockConfigType OS_CONST *   Os_LockListGetTop (
  const   Os_LockListType OS_VAR_NOINIT * LockList
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_LockType OS_VAR_NOINIT *   Os_LockGetDyn (
  const   Os_LockConfigType OS_CONST * Lock
);
