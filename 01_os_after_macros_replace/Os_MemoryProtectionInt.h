...
struct Os_MpSystemConfigType_Tag
{
  ...
  const   Os_Hal_MpSystemConfigType OS_CONST * HwConfig;
};
...
struct Os_MpCoreConfigType_Tag
{
  ...
  const   Os_Hal_MpCoreConfigType OS_CONST * HwConfig;
};
...
struct Os_MpAccessRightsType_Tag
{
   ...
   * \trace CREQ-41
   * \trace SPEC-64014 */
  const   Os_Hal_MpAppConfigType OS_CONST * AppAccessRights;

  /*! Memory protection configuration which shall be switched in case of thread switching.
   * \trace CREQ-62 */
  const   Os_Hal_MpThreadConfigType OS_CONST * ThreadAccessRights;
};


/*! Pointer to memory protection configuration. */
typedef const   Os_MpAccessRightsType OS_CONST * Os_MpAccessRightsRefType;
 ...
 *  \trace          CREQ-844
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_MpSystemInit (
  const   Os_MpSystemConfigType OS_CONST * SystemConfig
);
 ...
 *  \trace          CREQ-844
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_MpCoreInit (
  const   Os_MpCoreConfigType OS_CONST * CoreConfig,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_MpThreadInit (
  const   Os_MpAccessRightsType OS_CONST * Config,
    Os_MpAccessRightsRefType OS_VAR_NOINIT_FAST * Settings
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_MpIsEnabled (
  void
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_MpIsEnabledForApplications (
  void
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_MpIsEnabledForThreads (
  void
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_MpSwitch (
  const   Os_MpAccessRightsType OS_CONST * Current,
  const   Os_MpAccessRightsType OS_CONST * Next
);
 ...
 *  \pre            Concurrent access to memory protection hardware prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_MpSwitchTo (
