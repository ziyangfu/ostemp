 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_PeripheralConfigType OS_CONST *   Os_PeripheralId2Peripheral (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_PeripheralConfigType OS_CONST *   Os_PeripheralCheck (
  Os_PeripheralIdType PeripheralID
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_PeripheralCheck08 (
  Os_PeripheralIdType PeripheralID,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_PeripheralCheck16 (
  Os_PeripheralIdType PeripheralID,
  Os_AddressOfConstType Address
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_PeripheralCheck32 (
  Os_PeripheralIdType PeripheralID,
  Os_AddressOfConstType Address
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_PeripheralCheckId (
  Os_PeripheralIdType PeripheralID
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_PeripheralIsInAddressRange (
  const   Os_PeripheralConfigType OS_CONST * Peripheral,
  Os_AddressOfConstType Address,
  uint32 Size
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_PeripheralCheckAddressRange08 (
  const   Os_PeripheralConfigType OS_CONST * Peripheral,
  Os_AddressOfConstType Address
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_PeripheralCheckAddressRange16 (
  const   Os_PeripheralConfigType OS_CONST * Peripheral,
  Os_AddressOfConstType Address
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_PeripheralCheckAddressRange32 (
  const   Os_PeripheralConfigType OS_CONST * Peripheral,
  Os_AddressOfConstType Address
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_PeripheralConfigType OS_CONST *   Os_PeripheralId2Peripheral (
    Os_PeripheralIdType PeripheralID
)
{
 ...
 *
 */
uint16     Os_Api_ReadPeripheral16
(
  Os_PeripheralIdType PeripheralID,
 ...
 *
 */
uint32     Os_Api_ReadPeripheral32
(
  Os_PeripheralIdType PeripheralID,
 ...
 *
 */
void     Os_Api_ModifyPeripheral16
(
  Os_PeripheralIdType PeripheralID,
    uint16 OS_APPL_DATA * Address,
  uint16 ClearMask,
 ...
 *
 */
void     Os_Api_ModifyPeripheral32
(
  Os_PeripheralIdType PeripheralID,
    uint32 OS_APPL_DATA * Address,
  uint32 ClearMask,
...
\CM CM_OS_PERIPHERALID2PERIPHERAL
      Verify that:
        1. Verify that each peripheral region in OsCfg_PeripheralRefs is no ((void *)0),
