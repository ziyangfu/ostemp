 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_PriorityQueueNodeIdxType   Os_PriorityQueueSiblingIndex (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_PriorityQueueNodeIdxType   Os_PriorityQueueParentIndex (
  Os_PriorityQueueNodeIdxType NodeIdx
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_PriorityQueuePositionType   Os_PriorityQueueHeapUp (
 ...
 *  \pre             Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_PriorityQueuePositionType   Os_PriorityQueueHeapDown (
  const   Os_PriorityQueueConfigType OS_CONST * PriorityQueue,
  Os_PriorityQueueNodeIdxType NodeIdx
);
...
)
{
  ...
  while(current > OS_PRIORITYQUEUE_ROOT_IDX)
  {
    ...
    {
      const   Os_JobConfigType OS_APPL_DATA * tmpNode;
 ...
 *
 */
void     Os_PriorityQueueInsert
(
  const   Os_PriorityQueueConfigType OS_CONST * PriorityQueue,
  const   Os_JobConfigType   * Data
)
{
 ...
 *
 */
void     Os_PriorityQueueDeleteTop
(
  const   Os_PriorityQueueConfigType OS_CONST * PriorityQueue
)
{
 ...
 *
 */
Os_PriorityQueueDeleteResultType     Os_PriorityQueueDelete
(
  const   Os_PriorityQueueConfigType OS_CONST * PriorityQueue,
  const   Os_JobConfigType OS_APPL_DATA * Data
)
{
...
\CM CM_OS_PRIORITYQUEUE_QUEUE_DATA_M
      Verify that:
        1. Verify that the Queue pointer of each priority queue is no ((void *)0) and
...
\CM CM_OS_PRIORITYQUEUETOPGET_R
      Implementation ensures that the returned pointer is not used for write access if it is a ((void *)0).
 */
