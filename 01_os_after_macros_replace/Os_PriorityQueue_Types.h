...
typedef struct
{
  const   Os_JobConfigType OS_APPL_DATA * Data;      /*!< A pointer to the managed data. */
...
typedef struct
{
    Os_PriorityQueueNodeType OS_CONST * Queue;   /*!< The array which represents the queue. */
    Os_PriorityQueueType OS_CONST * Dyn;         /*!< Points to the runtime data of the queue. */
