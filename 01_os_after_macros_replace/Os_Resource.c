 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ResourceIsEnabled (
  void
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_ResourceType OS_VAR_NOINIT *   Os_ResourceGetDyn (
  const   Os_ResourceConfigType OS_CONST * Resource
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_ResourceInterruptType OS_VAR_NOINIT *   Os_ResourceInterruptGetDyn (
  const   Os_ResourceInterruptConfigType OS_CONST * Resource
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ResourceIsIntResource (
  const   Os_ResourceConfigType OS_CONST * Resource
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ResourceCheckPrio (
  const   Os_ResourceConfigType OS_CONST * Resource,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ResourceIsCeilingPrioGe (
  const   Os_ResourceConfigType OS_CONST * Resource,
  const   Os_ThreadConfigType OS_CONST * CurrentThread
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ResourceBaseIsCeilingPrioGe (
  const   Os_ResourceConfigType OS_CONST * Resource,
  const   Os_ThreadConfigType OS_CONST * CurrentThread
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ResourceInterruptIsCeilingPrioGe (
  const   Os_ResourceInterruptConfigType OS_CONST * Resource,
  const   Os_ThreadConfigType OS_CONST * CurrentThread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ResourceSaveAndIncrease (
  const   Os_ResourceConfigType OS_CONST * Resource,
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ResourceRestore (
  const   Os_ResourceConfigType OS_CONST * Resource,
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ResourceInterruptSaveAndIncrease (
  const   Os_ResourceInterruptConfigType OS_CONST * Resource
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ResourceConfigType OS_CONST *   Os_ResourceLock2Resource (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ResourceForceReleaseLocal (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ResourceInterruptConfigType OS_CONST *   Os_Resource2ResourceInterrupt (
  const   Os_ResourceConfigType OS_CONST * Resource
);
...
{
  return (  Os_ResourceType OS_VAR_NOINIT *)Os_LockGetDyn(&(Resource->Lock));                            /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* SBSW_OS_FC_PRECONDITION */
...
{
  return (  Os_ResourceInterruptType OS_VAR_NOINIT *)Os_ResourceGetDyn(&(Resource->Resource));           /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* SBSW_OS_FC_PRECONDITION */
}
...
)
{
  ...
  {
    const   Os_SchedulerConfigType OS_CONST * localScheduler;
...
{
    Os_ResourceInterruptType OS_VAR_NOINIT * resourceDyn;
...
{
  return (const   Os_ResourceConfigType OS_CONST *)(Lock);                                                   /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_ResourceForceReleaseLocal /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
(
    Os_LockListType OS_VAR_NOINIT * LockList,
  const   Os_ThreadConfigType OS_CONST * Thread
)
...
static inline const   Os_ResourceInterruptConfigType OS_CONST *   Os_Resource2ResourceInterrupt (
  const   Os_ResourceConfigType OS_CONST * Resource
)
{
  ...
  return (const   Os_ResourceInterruptConfigType OS_CONST *)(Resource);                                      /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 *
 */
void     Os_ResourceForciblyReleaseLocks
(
    const   Os_ThreadConfigType OS_CONST * Thread
)
{
  ...
  {
      Os_LockListType OS_VAR_NOINIT * it;
 ...
 *
 */
Os_StatusType     Os_Api_GetResource
(
  ResourceType ResID
)
{
  ...
  {
    const   Os_ResourceConfigType OS_CONST * me;
 ...
 *
 */
Os_StatusType     Os_Api_ReleaseResource
(
  ResourceType ResID
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      const   Os_TpConfigType OS_CONST * configTp;
      const   Os_TpThreadConfigType OS_CONST * configTpThread;
      const   Os_CoreAsrConfigType OS_CONST * localCore;
      ...
      if(Os_ThreadIsTask(currentThread) != 0u)                                                                          /* SBSW_OS_RES_THREADISTASK_001 */
      {
        const   Os_SchedulerConfigType OS_CONST * scheduler = Os_CoreGetScheduler(me->Core);                 /* SBSW_OS_RES_COREGETSCHEDULER_001 */
...
\CM CM_OS_RESOURCEID2RESOURCE_M
      Verify that:
        1. each resource pointer in OsCfg_ResourceRefs is no ((void *)0),
...
\CM CM_OS_RESOURCEGETDYN_M
      Verify that the Dyn pointer of each Os_ResourceConfigType object is a non ((void *)0).
...
\CM CM_OS_RESOURCE_CORE_M
      Verify that the Core pointer of each Os_ResourceConfigType object is initialized with a non ((void *)0).
