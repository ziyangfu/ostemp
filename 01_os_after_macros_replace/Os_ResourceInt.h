...
struct Os_ResourceInterruptConfigType_Tag
{
  ...
  const   Os_Hal_IntLevelType OS_CONST * InterruptLevel;
};
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ResourceCheckId (
  ResourceType ResourceId
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ResourceConfigType OS_CONST *   Os_ResourceId2Resource (
  ResourceType ResourceId
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_AppAccessMaskType   Os_ResourceGetAccessingApplications (
  const   Os_ResourceConfigType OS_CONST * Resource
);
