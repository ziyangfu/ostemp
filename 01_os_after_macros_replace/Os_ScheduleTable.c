 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_SchTIsEnabled (
  void
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_SchTStartScheduleTableRel (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Offset
);
 ...
 *  \pre            Given schedule table belongs to the local core.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_SchTGetScheduleTableStatus (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
 ...
 *  \pre            Given values have been checked before.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_SchTStartScheduleTableAbs (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Start
);
 ...
 *  \pre            Given schedule table belongs to the local core.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_SchTNextScheduleTable (
  const   Os_SchTConfigType OS_CONST * ScheduleTable_From,
  const   Os_SchTConfigType OS_CONST * ScheduleTable_To
);
 ...
 *  \pre            Given values have been checked before.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_SchTStopScheduleTable (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTConfigType OS_CONST *   Os_SchTJob2SchT (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTExPoSyncConfigType OS_CONST *   Os_SchTExPo2SyncExPo (
  const   Os_SchTExPoConfigType OS_CONST * ExPo
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_SchTType OS_VAR_NOINIT *   Os_SchTGetDyn (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTSyncConfigType OS_CONST *   Os_SchTSyncGet (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_SchTSyncType OS_VAR_NOINIT *   Os_SchTSyncGetDyn (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTable
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTExPoConfigType OS_CONST *   Os_SchTExPoGetCurrent (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTExPoSelectNext (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTSyncUpdateDeviation (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTable,
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTSyncScheduleTable (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTable,
  Os_TickType SyncTimeNow
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTIsSynchronizedExplicit (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTIsSynchronous (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTHasNextScheduleTable (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTConfigType OS_CONST *   Os_SchTSwitch (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsStopped (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsNotStopped (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsNotNexted (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsNotWaiting (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsNotSynchronizedImplicitly (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsSynchronizedExplicitly (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckUpperBound (
  Os_TickType Value,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckIsNotZero (
  Os_TickType Value
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTReinitNonSync (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTReinit (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  Os_SchTStatusType InitialState
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTSyncUpdateSyncStatus (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTSyncUpdateSyncPoint (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTExPoWorkAction (
  const   Os_SchTExPoConfigType OS_CONST * ExPo
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTWorkExpiryPointGeneral (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
    Os_TickType OS_VAR_NOINIT * RelativeOffsetToNext
);
 ...
 *  \trace          SPEC-63883
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTWorkExpiryPointWithSync (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
    Os_TickType OS_VAR_NOINIT * RelativeOffsetToNext
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTWorkExpiryPointWithSyncZero (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
    Os_TickType OS_VAR_NOINIT * RelativeOffsetToNext
);
 ...
 *  \trace          SPEC-63929
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTConfigType OS_CONST *   Os_SchTWorkExpiryPointLast (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
    Os_TickType OS_VAR_NOINIT * RelativeOffsetToNext
);
 ...
 *  \retval         ((void *)0)  If next schedule table not set.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTConfigType OS_CONST *   Os_SchTWorkExpiryPointLastSingleShot (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
    Os_TickType OS_VAR_NOINIT * RelativeOffsetToNext
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_SchTSyncMod (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
  Os_TickType Value
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_SchTSyncAddAndMod (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
  Os_TickType Lhs,
  Os_TickType Rhs
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_SchTSyncSub (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
  Os_TickType Lhs,
  Os_TickType Rhs
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_SchTSyncSubAndModHalfRange (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
  Os_TickType Lhs,
  Os_TickType Rhs
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_SchTSyncFull2HalfRange (
  const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync,
  Os_TickType Operand
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTStartRelative (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Offset
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTStartAbsolute (
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Start
);
 ...
 *  \trace          SPEC-63847
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SchTStartSynchronous (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_SchTGetInitialOffset (
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
...
)
{
  ...
  {
    const   Os_SchTType OS_VAR_NOINIT * dyn;
    ...
    else
    {
      ...
      switch(ScheduleTable->SyncKind)
      {
        ...
        case OS_SCHT_SYNC_KIND_EXPLICIT:
          {
            const   Os_SchTSyncConfigType OS_CONST * scheduleTableSync = Os_SchTSyncGet(ScheduleTable);      /* SBSW_OS_FC_PRECONDITION */
...
)
{
  ...
  {
      Os_SchTType OS_VAR_NOINIT * dyn_From;
      Os_SchTType OS_VAR_NOINIT * dyn_To;
    ...
    if((dyn_From->Next != ((void *)0)) && (dyn_From->Next != ScheduleTable_From))
    {
        Os_SchTType OS_VAR_NOINIT * dyn_Nexted = Os_SchTGetDyn(dyn_From->Next);                          /* SBSW_OS_SCHT_SCHTGETDYN_001 */
...
)
{
  ...
  else
  {
    ...
    {
        Os_SchTType OS_VAR_NOINIT * dynPrevious;
...
{
  return (const   Os_SchTConfigType OS_CONST *)Job;                                                          /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
)
{
  ...
  return (const   Os_SchTExPoSyncConfigType OS_CONST *)ExPo;                                                 /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (  Os_SchTType OS_VAR_NOINIT *)Os_JobGetDyn(&(ScheduleTable->Job));                             /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return (const   Os_SchTSyncConfigType OS_CONST *)ScheduleTable;                                            /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return (  Os_SchTSyncType OS_VAR_NOINIT *)Os_SchTGetDyn(&(ScheduleTable->SchT));                       /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */ /* SBSW_OS_FC_PRECONDITION */
}
...
{
    Os_SchTType OS_VAR_NOINIT * dyn = Os_SchTGetDyn(ScheduleTable);                                      /* SBSW_OS_FC_PRECONDITION */

  Os_Assert((Os_StdReturnType)(dyn->ExPo->Next != ((void *)0)));                                                           /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
...
{
    Os_SchTSyncType OS_VAR_NOINIT * dyn;
...
{
    Os_SchTType OS_VAR_NOINIT * dyn;
    Os_SchTSyncType OS_VAR_NOINIT * dynSync;
...
{
  const   Os_SchTSyncType OS_CONST * dynSync;
...
{
  const   Os_SchTType OS_CONST * dyn;

  dyn = Os_SchTGetDyn(ScheduleTable);                                                                                   /* SBSW_OS_FC_PRECONDITION */

  /* Schedule Table is neither self next nor single shot without successor. */
  return (Os_StdReturnType)((dyn->Next != ScheduleTable) && (dyn->Next != ((void *)0)));                                   /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
}
...
{
  const   Os_SchTConfigType OS_CONST * next;
    Os_SchTType OS_VAR_NOINIT * dyn = Os_SchTGetDyn(ScheduleTable);                                      /* SBSW_OS_FC_PRECONDITION */
  ...
  if(ScheduleTable != dyn->Next)
  {
    ...
    {
      const   Os_SchTSyncConfigType OS_CONST * scheduleTableSync;
      const   Os_SchTSyncType OS_VAR_NOINIT * dynSync;
      const   Os_SchTSyncConfigType OS_CONST * ScheduleTableSync_Next;
        Os_SchTSyncType OS_VAR_NOINIT * dynSync_Next;
...
)
{
  ...
  dyn->Previous = ((void *)0);                                                                                             /* SBSW_OS_SCHT_SCHTGETDYN_002 */
}
...
)
{
  ...
  /* #10 Activate all configured tasks. */
  {
    ...
    const   Os_SchTExPoActionTaskConfigType OS_CONST * actionTask = ExPo->Tasks;
  ...
  /* #20 Set each configured event. */
  {
    ...
    const   Os_TaskConfigType OS_CONST * eventTask;
    const   Os_SchTExPoActionEventConfigType OS_CONST * actionEvent = ExPo->Events;
...
)
{
  ...
  {
    const   Os_SchTExPoConfigType OS_CONST * exPo;
    const   Os_SchTExPoSyncConfigType OS_CONST * exPoSync;
 ...
 *
 */
Os_StatusType     Os_Api_StartScheduleTableRel
(
 ...
 *
 */
Os_StatusType     Os_Api_StartScheduleTableAbs
(
  ScheduleTableType ScheduleTableID,
  TickType Start
)
 ...
 *
 */
Os_StatusType     Os_Api_StopScheduleTable
(
  ScheduleTableType ScheduleTableID
)
{
 ...
 *
 */
Os_StatusType     Os_Api_NextScheduleTable
(
 ...
 *
 */
Os_StatusType     Os_Api_StartScheduleTableSynchron
(
  ScheduleTableType ScheduleTableID
)
{
 ...
 *
 */
Os_StatusType     Os_Api_SyncScheduleTable
(
  ScheduleTableType ScheduleTableID,
  TickType Value
)
 ...
 *
 */
Os_StatusType     Os_Api_SetScheduleTableAsync
(
  ScheduleTableType ScheduleTableID
)
{
 ...
 *
 */
Os_StatusType     Os_Api_GetScheduleTableStatus
(
  ScheduleTableType ScheduleTableID,
  ScheduleTableStatusRefType ScheduleStatus
)
...
{
  const   Os_SchTAutostartConfigType OS_CONST * autostartConfig = &SchT->Autostart;
 ...
 *
 */
Os_StatusType     Os_SchTStartScheduleTableRelLocal                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Offset
)
 ...
 *
 */
Os_StatusType     Os_SchTStartScheduleTableAbsLocal                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Start
)
 ...
 *
 */
Os_StatusType     Os_SchTStopScheduleTableLocal                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable
)
{
 ...
 *
 */
Os_StatusType     Os_SchTNextScheduleTableLocal                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable_From,
  const   Os_SchTConfigType OS_CONST * ScheduleTable_To
)
 ...
 *
 */
Os_StatusType     Os_SchTGetScheduleTableStatusLocal                                                         /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  ScheduleTableStatusRefType ScheduleStatus
)
 ...
 *
 */
void     Os_SchTWorkScheduleTable
(
  const   Os_JobConfigType OS_CONST * Job
)
{
  const   Os_SchTConfigType OS_CONST * currentSchT = Os_SchTJob2SchT(Job);                                     /* SBSW_OS_FC_PRECONDITION */
  ...
  while((currentSchT != ((void *)0)) && (relativeOffsetToNext == 0u));


  if(currentSchT != ((void *)0))
  {
...
\CM CM_OS_SCHTID2SCHT_M
      Verify that:
        1. each schedule table pointer in OsCfg_SchTRefs is no ((void *)0),
...
\CM CM_OS_EXPO_TASKS_M
      Verify that:
        1. each the Tasks pointer of each configured expiry point is a non ((void *)0), if the TaskCount is not '0',
        2. the size of the Tasks array is equal to TaskCount, if TaskCount is not '0' and
        3. each task reference is a non ((void *)0).

\CM CM_OS_EXPO_EVENTS_M
      Verify that:
        1. each the Events pointer of each configured expiry point is a non ((void *)0), if the EventCount is not '0',
        2. the size of the Events array is equal to EventCount, if EventCount is not '0' and
        3. the task reference in each element is a non ((void *)0).
...
\CM CM_OS_SCHTGETAPPLICATION_M
      Verify that the OwnerApplication reference in each schedule table instance is a non ((void *)0).
...
\CM CM_OS_SCHTGETNEXT_M
      Verify that the initial next pointer of each schedule table which has a cyclic expiry point is a non ((void *)0).
...
\CM CM_OS_SCHT_ITERATOR_R
      Caller ensures by implementation that the used iterator is not used, in case the the iterator is a ((void *)0).

\CM CM_OS_SCHT_NULLPTRCHECK_R
      Caller ensures by implementation that the passed value is a non ((void *)0).
