...
{
  /*! The next expiry point or a ((void *)0) */
  const   Os_SchTExPoConfigType OS_CONST * Next;
   ...
   *  \trace SPEC-64034 */
  const   Os_SchTExPoActionTaskConfigType OS_CONST * Tasks;
   ...
   *  \trace SPEC-63695 */
  const   Os_SchTExPoActionEventConfigType OS_CONST * Events;
...
struct Os_SchTConfigType_Tag
{
   ...
   *  \trace SPEC-63772 */
  const   Os_SchTExPoConfigType OS_CONST * ExPoHead;

  /*! \brief The schedule table which shall be started at the end of this schedule table.
   *  \details
   *  - InitialNext == ((void *)0): The schedule table is single shot
   *  - InitialNext == thisScheduleTable: The schedule table is cyclic.
   */
  const   Os_SchTConfigType OS_CONST * InitialNext;
};
...
struct Os_SchTType_Tag
{
  ...
  const   Os_SchTConfigType OS_CONST * Previous;
};
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SchTCheckId (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchTConfigType OS_CONST *   Os_SchTId2SchT (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CoreAsrConfigType OS_CONST *   Os_SchTGetCore (
  const   Os_SchTConfigType OS_CONST * SchT
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AppConfigType OS_CONST *   Os_SchTGetApplication (
  const   Os_SchTConfigType OS_CONST * SchT
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_SchTStartScheduleTableRelLocal
(
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_SchTStartScheduleTableAbsLocal
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
  TickType Start
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_SchTStopScheduleTableLocal
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_SchTNextScheduleTableLocal
(
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_SchTGetScheduleTableStatusLocal
(
  const   Os_SchTConfigType OS_CONST * ScheduleTable,
