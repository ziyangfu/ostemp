 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ServiceCheckTfId (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ServiceCheckFtfId (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ServiceCheckIsAccessible (
  const   Os_ServiceConfigType OS_CONST * ServiceFunction
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ServiceStackPoolCheckIsAllowedToGet (
  const   Os_ServiceStackPoolConfigType OS_CONST * StackPool,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_ServiceTfConfigType OS_CONST *   Os_ServiceTfId2Tf (
  TrustedFunctionIndexType Id
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_ServiceFtfConfigType OS_CONST *   Os_ServiceFtfId2Ftf (
  Os_FastTrustedFunctionIndexType Id
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ServiceIsTf (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ServiceIsNtf (
  const   Os_ServiceConfigType OS_CONST * Service
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ServiceTfConfigType OS_CONST *   Os_Service2Tf (
  const   Os_ServiceConfigType OS_CONST * Service
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ServiceNtfConfigType OS_CONST *   Os_Service2Ntf (
  const   Os_ServiceConfigType OS_CONST * Service
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_ServiceNtfCallType OS_VAR_NOINIT *   Os_ServiceCall2NtfCall (
    Os_ServiceCallType OS_VAR_NOINIT * ServiceCall
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline Os_StdReturnType   Os_ServiceTfNeedsModeSwitch (
  const   Os_ServiceTfConfigType OS_CONST * TrustedFunction
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
static inline void     Os_ServicePrologue
(
    Os_ServiceCallType OS_VAR_NOINIT * ServiceCall,
  const   Os_ServiceConfigType OS_CONST * Service,
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
static inline void     Os_ServiceEpilogue
(
  const   Os_ServiceCallType OS_VAR_NOINIT * ServiceCall,
  const   Os_ThreadConfigType OS_CONST * CurrentThread
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
static inline void     Os_ServiceStackPoolInit
(
  const   Os_ServiceStackPoolConfigType OS_CONST * StackPool
);
 ...
 *
 *  \return         Stack object.
 *  \retval         ((void *)0) if there is no further stack available.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
static inline const OS_CONST Os_ServiceStackConfigType       * Os_ServiceStackPoolGetStack
(
  const   Os_ServiceStackPoolConfigType OS_CONST * StackPool,
  ApplicationType CurrentApplication
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
static inline void     Os_ServiceStackPoolReleaseStack
(
  const   Os_ServiceStackPoolConfigType OS_CONST * StackPool,
  const    Os_ServiceStackConfigType OS_CONST * Stack,
 ...
 *  \pre            -
 **********************************************************************************************************************/
static inline Os_StatusType     Os_ServiceTfCall
(
  const   Os_ServiceTfConfigType OS_CONST * TrustedFunction,
 ...
 *  \pre            -
 **********************************************************************************************************************/
static inline Os_StatusType     Os_ServiceNtfCall
(
 ...
 *  \pre            -
 **********************************************************************************************************************/
static inline Os_StatusType     Os_ServiceFtfCall
(
  const   Os_ServiceFtfConfigType OS_CONST * FastTrustedFunction,
 ...
 *  \pre            -
 **********************************************************************************************************************/
void     Os_ServiceInitInternal                                                                              /* PRQA S 3449, 3451 */ /* MD_Os_Rule8.5_3449, MD_Os_Rule8.5_3451 */
(
  const   Os_ServiceConfigType OS_CONST * Service
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
static inline void     Os_ServiceNtfInit
(
  const   Os_ServiceNtfConfigType OS_CONST * NonTrustedFunction
);
 ...
 *  Os_Service2Tf()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE                                                                                            /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
static inline const   Os_ServiceTfConfigType OS_CONST *   Os_Service2Tf (
  const   Os_ServiceConfigType OS_CONST * Service
)                                                                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  Os_Assert(Os_ServiceIsTf(Service));                                                                                   /* SBSW_OS_FC_PRECONDITION */
  return (const   Os_ServiceTfConfigType OS_CONST *) Service;                                                /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_ServiceNtfConfigType OS_CONST *   Os_Service2Ntf (
  const   Os_ServiceConfigType OS_CONST * Service
)
{
  Os_Assert(Os_ServiceIsNtf(Service));                                                                                  /* SBSW_OS_FC_PRECONDITION */
  return (const   Os_ServiceNtfConfigType OS_CONST *) Service;                                               /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline   Os_ServiceNtfCallType OS_VAR_NOINIT *   Os_ServiceCall2NtfCall (
    Os_ServiceCallType OS_VAR_NOINIT * ServiceCall
)
{
  ...
  return (  Os_ServiceNtfCallType OS_VAR_NOINIT *) ServiceCall;                                          /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
...
{
  return ((Os_StdReturnType)(TrustedFunction->Context != ((void *)0)));                                                    /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */
}
...
)
{
  ...
  else
  {
    ...
    if(OS_UNLIKELY(ntfCall.Stack == ((void *)0)))
    {
 ...
 *
 */
OS_NORETURN void   Os_ServiceReturn (void)
{
 ...
 *
 */
OS_NORETURN void   Os_ServiceTfWrapper (
  const   Os_ServiceCallType OS_VAR_NOINIT * ServiceCall
)
{
 ...
 *
 */
OS_NORETURN void   /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
Os_ServiceNtfWrapper (
  const   Os_ServiceCallType OS_VAR_NOINIT * ServiceCall
)                                                                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
 ...
 *
 */
void     Os_ServiceCallForceRelease
(
 ...
 *
 */
Os_StatusType     Os_Api_CallTrustedFunction
(
  TrustedFunctionIndexType FunctionIndex,
  TrustedFunctionParameterRefType FunctionParams
)
{
  ...
  {
    const   Os_ServiceTfConfigType OS_CONST * trustedFunction;
    const   Os_CoreAsrConfigType OS_CONST * ownerCore;
 ...
 *
 */
Os_StatusType     Os_Api_CallNonTrustedFunction
(
  Os_NonTrustedFunctionIndexType FunctionIndex,
  Os_NonTrustedFunctionParameterRefType FunctionParams
)
 ...
 *
 */
Os_StatusType     Os_Api_CallFastTrustedFunction
(
  Os_FastTrustedFunctionIndexType FunctionIndex,
  Os_FastTrustedFunctionParameterRefType FunctionParams
)
...
\ID SBSW_OS_SF_THREADCALLCONTEXT_001
 \DESCRIPTION    Os_ThreadCallContext is called with the following arguments:
                 ...
                 TrustedFunction->Context: Pointer to a Context object derived from an argument of the caller
                   function. The correctness of the caller argument is ensured by precondition.
                   The correctness of the Context pointer is ensured to be no ((void *)0).
                 Others:
...
\ID SBSW_OS_SF_THREADCALLCONTEXTONSTACK_001
 \DESCRIPTION    Os_ThreadCallContextOnStack is called with the following arguments:
                 ...
                 Others:
                   Four further argument pointers are derived from local objects, therefore pointers are valid.
 \COUNTERMEASURE \M [CM_OS_SF_CONTEXT_M]
                 \R Runtime check ensures that ntfCall.Stack->HwConfig is no ((void *)0).
...
\CM CM_OS_SERVICETFID2TF_M
      ...
      Verify that:
        1. each TF in OsCfg_TrustedFunctionRefs is a non ((void *)0),
...
\CM CM_OS_SERVICEFTFID2FTF_M
      ...
      If the value is retrieved from a user interface, a range check is required.
      Verify that:
        1. each FTF in OsCfg_FastTrustedFunctionRefs is a non ((void *)0),
...
\CM CM_OS_SERVICENTFID2NTF_M
      Verify that:
        1. each NTF in OsCfg_NonTrustedFunctionRefs is a non ((void *)0),
...
\CM CM_OS_SERVICESTACKPOOL_M
      Verify that:
        1. that the StackPool of each Os_ServiceNtfConfigType is non ((void *)0),
        2. the Stacks reference of each Os_ServiceStackPoolConfigType is a non ((void *)0),
        3. each Stacks array has a size equal to StackCount
        4. that the Stack pointer of each Stack in each StackPool is a non ((void *)0) and
        5. that the HwConfig pointer of each Stack in each StackPool is a non ((void *)0).

\CM CM_OS_SF_STACKPOOL_DYN_M
      Verify that the Dyn pointer of each StackPoolConfigType object is a non ((void *)0).

\CM CM_OS_SF_INDEX_R
      Caller ensures by implementation that the used index is valid.

\CM CM_OS_SF_OWNERAPPLICATION_M
      Verify that the OwnerApplication pointer of each Os_ServiceConfigType object is a non ((void *)0).

\CM CM_OS_SF_MPACCESSRIGHTS_M
      Verify that the MpAccessRights pointer of each Os_ServiceConfigType object is a non ((void *)0).

\CM CM_OS_SF_TF_CALLBACKPOINTER_M
      Verify that the Callback pointer of each Os_ServiceTfConfigType object is a non ((void *)0).

\CM CM_OS_SF_FTF_CALLBACKPOINTER_M
      Verify that the Callback pointer of each Os_ServiceFtfConfigType object is a non ((void *)0).

\CM CM_OS_SF_NTF_CALLBACKPOINTER_M
      Verify that the Callback pointer of each Os_ServiceNtfConfigType object is a non ((void *)0).
...
\CM CM_OS_SF_CONTEXT_M
      Verify that the Context pointer of each Os_ServiceNtfConfigType object is a non ((void *)0).
