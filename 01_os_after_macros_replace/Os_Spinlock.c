 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockTraceOwnerGet (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockTraceOwnerRelease (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_Hal_SpinlockResultType   Os_SpinlockTraceOwnerTryGet (
  const   Os_SpinlockConfigType OS_VAR_NOINIT * Spinlock
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TaskPrioType   Os_SpinlockSuspendByMethod (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockResumeByMethod (
  const   Os_SpinlockConfigType OS_CONST * Spinlock,
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockListPush (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockListPop (void);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SpinlockIsNotLockedLocal (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SpinlockCheckIsNotLockedLocal (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SpinlockIsOwnerThread (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SpinlockCheckThreadIsOwner (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \trace        SPEC-63593
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SpinlockIsLockOrderValid (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_SpinlockCheckIsLockOrderValid (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline SpinlockIdType   Os_SpinlockGetSpinlockIdCount (
  void
);
...
)
{
  const   Os_ThreadConfigType OS_CONST * thread;
    Os_SpinlockListType OS_VAR_NOINIT * spinlockList;
...
OS_ALWAYS_INLINE static inline void   Os_SpinlockListPop (void)
{
  const   Os_ThreadConfigType OS_CONST * thread;
    Os_SpinlockListType OS_VAR_NOINIT * spinlockList;
  const   Os_SpinlockConfigType OS_CONST * topSpinlock;
...
{
  Os_StdReturnType result;
  const   Os_SpinlockListType OS_VAR_NOINIT * spinlockList;
  const   Os_SpinlockConfigType OS_CONST * previousSpinlock;
 ...
 *
 */
void     Os_SpinlockForciblyReleaseThreadLocks
(
  const   Os_ThreadConfigType OS_CONST * Thread
)
{
  ...
  {
    {
        Os_LockListType OS_VAR_NOINIT * locks;
...

    {
      /* #30 Empty thread's spinlock order list. */
        Os_SpinlockListType OS_VAR_NOINIT * spinlockOrderList;
 ...
 *
 */
Os_StatusType     Os_SpinlockRelease
(
 const   Os_SpinlockConfigType OS_CONST * Spinlock
)
{
  ...
  if(OS_UNLIKELY(Spinlock->Checks == OS_SPINLOCKCHECK_ENABLED))
  {
    const   Os_ThreadConfigType OS_CONST * currentThread;
    const   Os_AppConfigType OS_CONST * currentApplication;
    const   Os_LockListType OS_VAR_NOINIT * locks;
 ...
 *
 */
Os_StatusType     Os_SpinlockTryGet
(
  const   Os_SpinlockConfigType OS_CONST * Spinlock,
 ...
 *
 */
Os_StatusType     Os_Api_GetSpinlock
(
 ...
 *
 */
Os_StatusType     Os_Api_ReleaseSpinlock(SpinlockIdType SpinlockId)
{
  Os_StatusType status;
 ...
 *
 */
Os_StatusType     Os_Api_TryToGetSpinlock
(
  SpinlockIdType SpinlockId,
  TryToGetSpinlockType* Success
)
...
\CM CM_OS_SPINLOCKID2SPINLOCK_M
      Verify that:
        1. each spinlock pointer in OsCfg_SpinlockRefs is not ((void *)0),
...
\CM CM_OS_SPINLOCKGETDYN_M
      Verify that the Dyn pointer of each Spinlock is a non ((void *)0).

\CM CM_OS_SPINLOCK_OWNERTHREAD_R
      Implementation ensures that the OwnerThread is a non ((void *)0).
...
\CM CM_OS_SL_SPINLOCK_TIMINGHOOKTRACE_M
      Verify that the TimingHookTrace of each Spinlock is a non ((void *)0), if TimingHook tracing is enabled.
