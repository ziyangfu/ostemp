...
#define OS_SPINLOCK_LIST_END            ((const   Os_SpinlockConfigType OS_CONST *)(((void *)0)))
...
struct Os_SpinlockType_Tag
{
  ...
  /*! Points to the owner thread or is a ((void *)0). */
  const   Os_ThreadConfigType OS_CONST * OwnerThread;
...
struct Os_SpinlockConfigType_Tag
{
  ...
  const   Os_TraceSpinlockConfigType OS_CONST * TimingHookTrace;
};
...
OS_ALWAYS_INLINE static inline void   Os_SpinlockListInit (
    Os_SpinlockListType OS_VAR_NOINIT * LockList
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockInit (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_SpinlockType OS_VAR_NOINIT *   Os_SpinlockGetDyn (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SpinlockConfigType OS_CONST *   Os_SpinlockId2Spinlock (
  SpinlockIdType SpinlockId
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockInternalGet (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \pre            If forcible termination is enabled, this function has to be called in supervisor mode.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_SpinlockInternalRelease (
  const   Os_SpinlockConfigType OS_CONST * Spinlock
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_GetSpinlock(SpinlockIdType SpinlockId);
