 ...
 **********************************************************************************************************************/
void     Os_StackInitInternal                                                                                /* PRQA S 3449, 3451 */ /* MD_Os_Rule8.5_3449, MD_Os_Rule8.5_3451 */
(
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_StackIsPartOfStack (
  const   Os_StackConfigType OS_CONST * Stack,
  const   Os_Hal_StackType OS_CONST * CheckAddress
);
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_StackMonitoringInit (
  const   Os_StackConfigType OS_CONST * Stack
);
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_StackFill (
  const   Os_StackConfigType OS_CONST * Stack
);
 ...
 **********************************************************************************************************************/
static uint32     Os_StackGetUsageLocal
(
  const   Os_StackConfigType OS_CONST * Stack
);
...
)
{
  ...
  {
      Os_Hal_StackType OS_VAR_NOINIT * endOfStack;
...
)
{
  ...
  {
      Os_Hal_StackType OS_VAR_NOINIT * iterator;
      Os_Hal_StackType OS_VAR_NOINIT * iteratorEnd;
      Os_Hal_StackType OS_VAR_NOINIT * topOfStack;
 ...
 *
 */
uint32     Os_StackGetTaskStackUsageLocal                                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 ...
 *
 */
uint32     Os_StackGetISRStackUsageLocal                                                                     /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 ...
 *
 */
uint32     Os_StackGetKernelStackUsageLocal                                                                  /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 ...
 *
 */
uint32     Os_StackGetStartupHookStackUsageLocal                                                             /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_CoreAsrConfigType OS_CONST * Core
)
{
 ...
 *
 */
uint32     Os_StackGetErrorHookStackUsageLocal                                                               /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_CoreAsrConfigType OS_CONST * Core
)
{
 ...
 *
 */
uint32     Os_StackGetShutdownHookStackUsageLocal                                                            /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_CoreAsrConfigType OS_CONST * Core
)
{
 ...
 *
 */
uint32     Os_StackGetProtectionHookStackUsageLocal                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_CoreAsrConfigType OS_CONST * Core
)
{
 ...
 *
 */
uint32     Os_StackGetNonTrustedFunctionStackUsageLocal
(
 ...
 *
 */
uint32     Os_Api_GetTaskStackUsage
(
  TaskType TaskID
)
{
 ...
 *
 */
uint32     Os_Api_GetISRStackUsage
(
  ISRType IsrID
)
{
 ...
 *
 */
uint32     Os_Api_GetKernelStackUsage
(
  CoreIdType CoreID
)
{
 ...
 *
 */
uint32     Os_Api_GetStartupHookStackUsage
(
  CoreIdType CoreID
)
{
 ...
 *
 */
uint32     Os_Api_GetErrorHookStackUsage
(
  CoreIdType CoreID
)
{
 ...
 *
 */
uint32     Os_Api_GetShutdownHookStackUsage
(
  CoreIdType CoreID
)
{
 ...
 *
 */
uint32     Os_Api_GetProtectionHookStackUsage
(
  CoreIdType CoreID
)
{
 ...
 *
 */
uint32     Os_Api_GetNonTrustedFunctionStackUsage
(
...
\CM CM_OS_STACK_HIGHADDRESS_M
      ...
      OS_STACK_GETHIGHADDRESS and a non ((void *)0).
