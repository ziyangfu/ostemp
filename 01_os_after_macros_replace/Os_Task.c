 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TaskIsPreTaskHookEnabled ( void );
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TaskCheckIsScheduleAllowed (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TaskCheckIsActivationAllowed (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
static void     Os_TaskInternalInit
(
  const   Os_TaskConfigType OS_CONST * Task
);
...
)
{
  ...
  Os_Assert((Os_StdReturnType)(Os_TaskGetThread(Task) != ((void *)0)));                                                    /* PRQA S 2995, 4304 */ /* MD_Os_Rule2.2_2995, MD_Os_C90BooleanCompatibility */ /* SBSW_OS_FC_PRECONDITION */
  ...
  Os_Assert((Os_StdReturnType)(Os_TaskGetDyn(Task) != ((void *)0)));                                                       /* PRQA S 4304 */ /* MD_Os_C90BooleanCompatibility */ /* SBSW_OS_FC_PRECONDITION */
 ...
 *
 */
Os_StatusType     Os_Api_ActivateTask
(
  TaskType TaskID
)
{
  ...
  else
  {
    ...
    const   Os_TaskConfigType OS_CONST * targetTask;
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_CoreAsrIsCoreLocal(targetCore) != 0u))                                                            /* SBSW_OS_TASK_COREASRISCORELOCAL_001 */ /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* PRQA S 2991, 2995 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule2.2_2995 */
      {
        ...
        if(OS_LIKELY(status == OS_STATUS_OK))
        {
          ...
          {
            const   Os_CoreAsrConfigType OS_CONST * localCore = Os_ThreadGetCore(currentThread);             /* SBSW_OS_TASK_THREADGETCORE_001 */
            const   Os_SchedulerConfigType OS_CONST * scheduler = Os_CoreGetScheduler(localCore);            /* SBSW_OS_TASK_COREGETSCHEDULER_001 */
...
{
  Os_StatusType status;
  const   Os_ThreadConfigType OS_CONST * taskThread;
  ...
  {
      Os_TaskType OS_VAR_NOINIT * taskDyn;
...
{
  Os_StatusType status;
  const   Os_ThreadConfigType OS_CONST * taskThread = Os_TaskGetThread(Task);                                /* SBSW_OS_FC_PRECONDITION */
  const   Os_TpConfigType OS_CONST * timingProtection;
 ...
 *
 */
Os_StatusType     Os_Api_ChainTask
(
  TaskType TaskID
)
{
 ...
 *
 */
Os_StatusType     Os_Api_GetTaskState
(
  TaskType TaskID,
  TaskStateRefType State
)
...
\CM CM_OS_TASKID2TASK_M
      Verify that:
        1. each task pointer in OsCfg_TaskRefs except the last is no ((void *)0),
