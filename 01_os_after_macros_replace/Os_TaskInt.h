 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TaskConfigType OS_CONST *   Os_TaskId2Task (
  TaskType TaskId
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_ThreadConfigType OS_CONST *   Os_TaskGetThread (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TaskConfigType OS_CONST *   Os_TaskThread2Task (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_TaskType OS_VAR_NOINIT *   Os_TaskGetDyn (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskSetState (
  const   Os_TaskConfigType OS_CONST * Task,
  TaskStateType State
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskSetPriority (
  const   Os_TaskConfigType OS_CONST * Task,
  Os_TaskPrioType Priority
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_ActivationCntType   Os_TaskGetMaxActivations (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_SchedulerConfigType OS_CONST *   Os_TaskGetScheduler (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_EventStateType OS_CONST *   Os_TaskGetEvent (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CoreAsrConfigType OS_CONST *   Os_TaskGetCore (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint32   Os_TaskIsCoreLocal (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline uint32   Os_TaskIsWaiting (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TaskIsSuspended (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_TaskActivateLocalTask
(
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_TaskActivateRestartTask
(
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskSwitch (
 ...
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_TaskResume (
  const   Os_SchedulerConfigType OS_CONST * Scheduler
);
 ...
 *  \trace          SPEC-64030
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskWait (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskLeaveWaitingState (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_TaskReturnToTaskLevel (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StatusType   Os_TaskGetStateLocal (
  const   Os_TaskConfigType OS_CONST * Task,
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_TaskGetStateInternal
(
  const   Os_TaskConfigType OS_CONST * Task,
  TaskStateRefType State
);
 ...
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_TaskSuicide (void);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskPreTaskHook (void);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskPostTaskHook (void);
 ...
 **********************************************************************************************************************/
void     Os_TaskCallPreTaskHook(void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AccessCheckConfigType OS_CONST *   Os_TaskGetAccessRights (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_TaskBeginScheduling (
  void
);
 ...
 *  \pre            After initialization, this function shall only be called by the scheduler.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskInitRoundRobinCounter (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TaskRoundRobinCount (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TaskIsRoundRobinNeeded (
  const   Os_TaskConfigType OS_CONST * Task
);
 ...
 **********************************************************************************************************************/
OS_NORETURN void   Os_TaskMissingTerminateTask (void);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_ActivateTask(TaskType TaskID);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_TerminateTask(void);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_ChainTask(TaskType TaskID);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_Schedule(void);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_GetTaskID(TaskRefType TaskID);
 ...
 **********************************************************************************************************************/
Os_StatusType     Os_Api_GetTaskState(TaskType TaskID, TaskStateRefType State);
