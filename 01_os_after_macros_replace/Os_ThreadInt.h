...
struct Os_ThreadType_Tag
{
  ...
  const   Os_AppConfigType OS_CONST * Application;

  /*! Current memory protection settings. */
  const   Os_MpAccessRightsType OS_CONST * MpAccessRights;
 ...
 *
 * */
    Os_IntApiStateType OS_VAR_NOINIT * IntApiState;

  /*! Configured timing protection settings for this thread.*/
  const   Os_TpThreadConfigType OS_CONST * TimeProtConfig;

  /*! Configured memory protection settings for this thread. */
  const   Os_MpAccessRightsType OS_CONST * MpAccessRightsInitial;

  /*! Pointer to an array of configured memory access rights. */
  const   Os_AccessCheckConfigType OS_CONST * AccessRights;

  /*! Pointer to the configured trace data. */
  const   Os_TraceThreadConfigType OS_CONST * Trace;
   ...
   *  may be NULL if FPU context is not needed. */
    Os_Hal_ContextFpuContextType OS_VAR_NOINIT * FpuContext;

  /*! Initial call context. */
  Os_CallContextType InitialCallContext;

  /*! Hook to be called before Thread is started/resumed. May be ((void *)0). */
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TraceThreadConfigType OS_CONST *   Os_ThreadGetTrace (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TpThreadConfigType OS_CONST *   Os_ThreadGetTpConfig (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_StackConfigType OS_CONST *   Os_ThreadGetStack (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_Hal_ContextConfigType OS_CONST *   Os_ThreadGetContext (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_IntApiStateType OS_VAR_NOINIT *   Os_ThreadGetInterruptApiState (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CoreAsrConfigType OS_CONST *   Os_ThreadGetCore (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AppConfigType OS_CONST *   Os_ThreadGetOwnerApplication (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AppConfigType OS_CONST *   Os_ThreadGetCurrentApplication (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadSetCurrentApplication (
  const   Os_ThreadConfigType OS_CONST * Thread,
  const   Os_AppConfigType OS_CONST * App
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ThreadCheckSpinlocksReleased (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadSpinlockForceRelease (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            The given task is assigned to the local core.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadResourceForceRelease (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            The given task is assigned to the local core.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadLocksForceRelease (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadInit (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadClassInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadInit2 (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_ThreadResetAndResume (
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadStartFirst (
  const   Os_ThreadConfigType OS_CONST * Next,
  boolean CallPreThreadHook
);
 ...
 *
 **********************************************************************************************************************/
OS_NORETURN OS_ALWAYS_INLINE static inline void   Os_ThreadCleanupAndResume (
  const   Os_ThreadConfigType OS_CONST * Next,
  boolean CallPreThreadHook
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadKill (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_NORETURN void   Os_ThreadSuicide (void);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadSwitch (
 ...
 *  \trace          SPEC-63778
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadSuspendAndStart (
  const   Os_ThreadConfigType OS_CONST * Current,
  const   Os_ThreadConfigType OS_CONST * Next,
  boolean CallPreThreadHook
);
 ...
 *  \retval         ((void *)0)  If the thread has no access rights configured.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_AccessCheckConfigType OS_CONST *   Os_ThreadGetAccessRights (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline const   Os_MpAccessRightsType OS_CONST *   Os_ThreadGetMpAccessRights (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadCallPreThreadHook (
  const   Os_ThreadConfigType OS_CONST * Thread,
  boolean CallPreThreadHook
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(static inline void,    , OS_ALWAYS_INLINE,
Os_ThreadCallContextOnStack,
(
  const   Os_ThreadConfigType OS_CONST * Thread,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE 
static inline void   Os_ThreadInitFpuContext (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadInitFpu (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadStoreFpuContext (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_ThreadRestoreFpuContext (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ThreadIsFpuContextEnabledForThread (
  const   Os_ThreadConfigType OS_CONST * Thread
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ThreadAllThreadsUseFpu (
  void
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_ThreadIsFpuContextEnabled (
  void
);
