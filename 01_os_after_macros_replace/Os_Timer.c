 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TimerIsrConfigType OS_CONST *   Os_TimerThread2CounterIsr (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TimerPitCheckNotPending (
  const   Os_TimerPitConfigType OS_CONST * PitCounter
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE  static inline void   Os_TimerPfrtSetNextHardwareCompareValue (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline   Os_TimerPfrtType OS_VAR_NOINIT *   Os_TimerPfrtGetDyn (
  const   Os_TimerPfrtConfigType OS_CONST * Timer
);
...
{
  return (const   Os_TimerIsrConfigType OS_CONST *)Thread;                                                   /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
 ...
 *  Os_TimerPitCheckNotPending()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   /* COV_OS_HALPLATFORMPITUNSUPPORTED_XX */
Os_TimerPitCheckNotPending (
  const   Os_TimerPitConfigType OS_CONST * PitCounter
...
{
    Os_TimerPfrtType OS_VAR_NOINIT * dyn;
  Os_TickType compare;
  Os_TickType now;
 ...
 *  Os_TimerPfrtGetDyn()
 **********************************************************************************************************************/
/* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */ /* COV_OS_HALPLATFORMPFRTUNSUPPORTED_XX */
OS_ALWAYS_INLINE static inline   Os_TimerPfrtType OS_VAR_NOINIT *   Os_TimerPfrtGetDyn (
  const   Os_TimerPfrtConfigType OS_CONST * Timer
)                                                                                                                      /* COV_OS_HALPLATFORMPFRTUNSUPPORTED_XX */
{
  return (  Os_TimerPfrtType OS_VAR_NOINIT *)((Timer->SwCounter).Dyn);                                   /* PRQA S 0310, 3305 */ /* MD_Os_Rule11.3_0310, MD_Os_Rule11.3_03305 */
}
 ...
 *
 */
void     Os_TimerPfrtStart                                                                                   /* COV_OS_HALPLATFORMPFRTUNSUPPORTED_XX */
(
  const   Os_TimerPfrtConfigType OS_CONST * Timer
)
{
...
{
  const   Os_TimerIsrConfigType OS_CONST * me;
  const   Os_TimerPitConfigType OS_CONST * pitCounter;
  ...
  pitCounter = (const   Os_TimerPitConfigType OS_CONST *) me->Counter;                                       /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
...
{
  const   Os_TimerIsrConfigType OS_CONST * me;
  const   Os_TimerHrtConfigType OS_CONST * hrtCounter;
  ...
  hrtCounter = (const   Os_TimerHrtConfigType OS_CONST *) me->Counter;                                       /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
...
{
  const   Os_TimerIsrConfigType OS_CONST * me;
  const   Os_TimerPfrtConfigType OS_CONST * pfrtTimer;
  ...
  pfrtTimer = (const   Os_TimerPfrtConfigType OS_CONST *) me->Counter;                                       /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
...
\CM CM_OS_TIMERPITHWCONFIG_M
      Verify that the HwConfig reference in each PIT instance is a non ((void *)0).

\CM CM_OS_TIMERHRTHWCONFIG_M
      Verify that the HwConfig reference in each HRT instance is a non ((void *)0).
