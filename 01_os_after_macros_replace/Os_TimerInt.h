...
struct Os_TimerSwConfigType_Tag
{
  ...
  /*! Dynamic part of the software counter. */
    Os_TimerSwType OS_VAR_NOINIT * Dyn;
};
...
struct Os_TimerPitConfigType_Tag
{
  ...
  const   Os_Hal_TimerPitConfigType OS_CONST * HwConfig;
};
...
struct Os_TimerHrtConfigType_Tag
{
  ...
  /*! Dynamic information. */
    Os_TimerHrtType OS_VAR_NOINIT * Dyn;

  /*! Hardware specific information of the FRT. */
  const   Os_Hal_TimerFrtConfigType OS_CONST * HwConfig;
};
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerSwInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerPitInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerHrtInit (
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerPfrtInit (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerSwStart (
  const   Os_TimerSwConfigType OS_CONST * Timer
);
 ...
 *  \trace          SPEC-64005
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerPitStart (
  const   Os_TimerPitConfigType OS_CONST * Timer
);
 ...
 *  \trace          SPEC-64005
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerHrtStart (
  const   Os_TimerHrtConfigType OS_CONST * Timer
);
 ...
 *                  with of Os_TickType.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerSwGetValue (
  const   Os_TimerSwConfigType OS_CONST * Timer
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerSwUserModulo (
  const   Os_TimerSwConfigType OS_CONST * Timer,
  Os_TickType Value
);
 ...
 *                  with of Os_TickType.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerPitGetValue (
  const   Os_TimerPitConfigType OS_CONST * Timer
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerPitSetCompareValue (
  const   Os_TimerPitConfigType OS_CONST * Timer,
  Os_TickType ExpirationTime
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerPitUserModulo (
  const   Os_TimerPitConfigType OS_CONST * Timer,
  Os_TickType Value
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerPfrtUserModulo (
  const   Os_TimerPfrtConfigType OS_CONST * Timer,
  Os_TickType Value
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerHrtGetValue (
  const   Os_TimerHrtConfigType OS_CONST * Timer
);
 ...
 *  \pre            The ValueMask of the given counter is zero or the maximum possible value in TickType
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerPfrtGetValue (
  const   Os_TimerPfrtConfigType OS_CONST * Timer
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_CounterConfigType OS_CONST *   Os_TimerHrtGetCounter (
  const   Os_TimerHrtConfigType OS_CONST * Timer
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerHrtComputeHardwareCompareValue (
  const   Os_TimerHrtConfigType OS_CONST * Timer,
  Os_TickType ExpirationTime
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerHrtSetCompareValue (
  const   Os_TimerHrtConfigType OS_CONST * Timer,
  Os_TickType ExpirationTime
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerPfrtSetCompareValue (
  const   Os_TimerPfrtConfigType OS_CONST * Timer,
  Os_TickType ExpirationTime
);
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerHrtGetCompareValue (
  const   Os_TimerHrtConfigType OS_CONST * Timer
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerHrtUserModulo (
  const   Os_TimerHrtConfigType OS_CONST * Timer,
  Os_TickType Value
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerHrtAcknowledge (
  const   Os_TimerHrtConfigType OS_CONST * Timer
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TimerHrtIsLogicalCompareValueReached (
  const   Os_TimerHrtConfigType OS_CONST * Timer
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerSwAbsCounter2AbsTimerValue (
  Os_TickType MaxAllowedValue,
  Os_TickType Now,
 ...
 *  \pre          All jobs which have to expire Now have already been removed from the job queue.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerPitAbsCounter2AbsTimerValue (
  Os_TickType MaxAllowedValue,
  Os_TickType Now,
  Os_TickType CounterValue
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerHrtAbsCounter2AbsTimerValue (
  Os_TickType MaxAllowedValue,
  Os_TickType MaxCountingValue,
  Os_TickType Now,
  Os_TickType CounterValue
 ...
 *  \pre          All jobs which have to expire Now have already been removed from the job queue.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerPfrtAbsCounter2AbsTimerValue (
  Os_TickType MaxAllowedValue,
  Os_TickType Now,
  Os_TickType CounterValue
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerAdd (
  Os_TickType MaxCountingValue,
  Os_TickType Value,
  Os_TickType Add
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerSub (
  Os_TickType MaxCountingValue,
  Os_TickType Value,
  Os_TickType Sub
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TimerFrtSetCompareValue (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TimerIsFrtLongCorrectionNeeded (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TimerIsFrtShortCorrectionNeeded (void);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TimerFrtTickType2TickType (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_Hal_TimerFrtTickType   Os_TimerTickType2FrtTickType (
  Os_TickType Value
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TimerIsCompareValueCorrectionNeeded (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_Hal_TimerFrtTickType   Os_TimerFrtGetLongValueMask (void);
