...
struct Os_TpBudgetType_Tag
{
  ...
  /*! Previous budget. */
  const   Os_TpBudgetConfigType OS_CONST * Previous;
};
...
struct Os_TpBudgetConfigType_Tag
{
  /*! Dynamic data of a timing protection budget. */
    Os_TpBudgetType OS_VAR_NOINIT * Dyn;
...
struct Os_TpOwnerThreadType_Tag
{
  ...
  const   Os_TpBudgetConfigType OS_CONST * MonitoredBudgets;
...
struct Os_TpOwnerThreadConfigType_Tag
{
  ...
  const   Os_TpBudgetConfigRefType OS_CONST * ResourceLockBudgets;
   ...
   * \details As there is no Dyn object within the base class, the Dyn pointer is located here. */
    Os_TpOwnerThreadType OS_VAR_NOINIT * Dyn;
};
...
struct Os_TpType_Tag
{
  ...
  const   Os_ThreadConfigType OS_CONST * MonitoredThread;
};
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TpOwnerThreadConfigType OS_CONST *   Os_TpGetCurrentTpOwnerThread (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpThreadInit (
  const   Os_TpConfigType OS_CONST * Config,
 ...
 *  \pre          The timing protection of the owner core is initialized.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpThreadKill (
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpResume (
  const   Os_TpConfigType OS_CONST * Config,
  Os_TickType Now,
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpSuspend (
  const   Os_TpConfigType OS_CONST * Config,
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TpSub (
  const   Os_TpConfigType OS_CONST * Config,
  Os_TickType Value,
  Os_TickType Sub
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TickType   Os_TpAdd (
  const   Os_TpConfigType OS_CONST * Config,
  Os_TickType Value,
  Os_TickType Add
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpResetAndResume (
  const   Os_TpConfigType OS_CONST * Config,
  const   Os_TpThreadConfigType OS_CONST * Current,
  const   Os_TpThreadConfigType OS_CONST * Next,
  const   Os_ThreadConfigType OS_CONST * NextThread
 ...
 *  \trace        SPEC-64030
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpResetAfterWait (
  const   Os_TpConfigType OS_CONST * Config,
  const   Os_TpThreadConfigType OS_CONST * Current
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TpCheckInterArrival (
  const   Os_TpConfigType OS_CONST * Config,
  const   Os_TpThreadConfigType OS_CONST * TpThread
);
 ...
 *  \pre          Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpUpdateViolation (
  const   Os_TpOwnerThreadConfigType OS_CONST * Current,
  Os_TpMonitoringType Violation
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStartResource (
  const   Os_TpConfigType OS_CONST * Config,
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_TpBudgetConfigType OS_CONST *   Os_TpGetResourceBudget (
  const   Os_TpOwnerThreadConfigType OS_CONST * Current,
  ResourceType Resource
);
 ...
 *  \trace        CREQ-847, CREQ-31
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStopResource (
  const   Os_TpConfigType OS_CONST * Config,
  const   Os_TpThreadConfigType OS_CONST * TpThread,
  ResourceType Resource
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStartDelay (
  const   Os_TpConfigType OS_CONST * Config
);
 ...
 *  \trace        SPEC-64022, SPEC-63997
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStopDelay (
  const   Os_TpConfigType OS_CONST * Config
);
 ...
 *  \trace        CREQ-847, CREQ-31
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStartAllInterrupt (
  const   Os_TpConfigType OS_CONST * Config
);
 ...
 *  \trace        CREQ-847, CREQ-31
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStopAllInterrupt (
  const   Os_TpConfigType OS_CONST * Config
);
 ...
 *  \trace        CREQ-847, CREQ-31
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStartOsInterrupt (
  const   Os_TpConfigType OS_CONST * Config
);
 ...
 *  \trace        CREQ-847, CREQ-31
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpStopOsInterrupt (
  const   Os_TpConfigType OS_CONST * Config
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpBudgetStart (
  const   Os_TpConfigType OS_CONST * Config,
  const   Os_TpOwnerThreadConfigType OS_CONST * Current,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TpBudgetStop (
  const   Os_TpConfigType OS_CONST * Config,
  const   Os_TpOwnerThreadConfigType OS_CONST * Current,
  const   Os_TpBudgetConfigType OS_CONST * Budget
);
