...
struct Os_TraceThreadConfigType_Tag
{
  /*! The dynamic trace data of this thread. */
    Os_TraceThreadType OS_VAR_NOINIT * Dyn;
...
struct Os_TraceCoreType_Tag
{
    ...
    // const Os_TraceThreadConfigType * CurrentTask;
    const   Os_TraceThreadConfigType OS_CONST * CurrentTask;
    /*! The currently traced ISR (for ORTI only tasks and ISRs are relevant) */
    const   Os_TraceThreadConfigType OS_CONST * CurrentIsr;
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsScheduleTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsForcedTerminationTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsActivationTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsActivationLimitTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsSetEventTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsWaitEventTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsGotResourceTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsRelResourceTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsReqSpinlockTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsGotSpinlockTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsRelSpinlockTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsDisabledIntTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsEnabledIntTimingHookEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsOrtiServiceTracingEnabled ( void );
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_TraceIsOrtiTaskIsrTracingEnabled ( void );
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceThreadInit (
  const   Os_TraceThreadConfigType OS_CONST * Thread
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceThreadInitAndStart (
  const   Os_TraceThreadConfigType OS_CONST * Task
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceThreadSwitch (
  TaskStateType CurrentTaskState,
  const   Os_TraceThreadConfigType OS_CONST * Current,
  const   Os_TraceThreadConfigType OS_CONST * Next
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceThreadResetAndResume (
  const   Os_TraceThreadConfigType OS_CONST * Current,
  const   Os_TraceThreadConfigType OS_CONST * Next
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceThreadCleanupAndResume (
  const   Os_TraceThreadConfigType OS_CONST * Current,
  const   Os_TraceThreadConfigType OS_CONST * Next
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceThreadSuspendAndStart (
  const   Os_TraceThreadConfigType OS_CONST * Current,
  const   Os_TraceThreadConfigType OS_CONST * Next
);
 ...
 *  \trace          CREQ-115030
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceIsrKill (
  const   Os_TraceThreadConfigType OS_CONST * KilledIsr
);
 ...
 *  \trace          CREQ-115030
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceTaskKill (
  const   Os_TraceThreadConfigType OS_CONST * KilledTask,
 ...
 *  \trace          CREQ-115010
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceTaskActivate (
  const   Os_TraceThreadConfigType OS_CONST * Task
);
 ...
 *  \trace          CREQ-140268
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceTaskActivateLimit (
  const   Os_TraceThreadConfigType OS_CONST * Task
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceTaskSetEvent (
  const   Os_TraceThreadConfigType OS_CONST * Task,
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceTaskWaitEventNoWait (
  const   Os_TraceThreadConfigType OS_CONST * Task,
  EventMaskType EventMask
);
 ...
 *  \trace          CREQ-115031
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceResourceTaken (
    ResourceType ResId
);
 ...
 *  \trace          CREQ-115032
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceResourceReleased (
    ResourceType ResId
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceSpinlockRequested (
    const   Os_TraceSpinlockConfigType OS_CONST * Spinlock
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceSpinlockTaken (
    const   Os_TraceSpinlockConfigType OS_CONST * Spinlock
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceSpinlockReleased (
    const   Os_TraceSpinlockConfigType OS_CONST * Spinlock
);
 ...
 *  \trace          CREQ-115039
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceInterruptsGlobalDisabled (
    void
);
 ...
 *  \trace          CREQ-115039
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceInterruptsLevelDisabled (
    void
);
 ...
 *  \trace          CREQ-115040
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceInterruptsGlobalEnabled (
    void
);
 ...
 *  \trace          CREQ-115040
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceInterruptsLevelEnabled (
    void
);
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceOrtiApiEntry (
 ...
 *
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_TraceOrtiApiExit (
    OsOrtiApiIdType ServiceId
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_TraceSpinlockIdType   Os_TraceGetNumberOfConfiguredSpinlocks ( void );
