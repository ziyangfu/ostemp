...
typedef   TaskType OS_VAR_NOINIT_FAST * TaskRefType;
...
typedef   TaskStateType OS_VAR_NOINIT_FAST * TaskStateRefType;
...
typedef   EventMaskType OS_VAR_NOINIT * EventMaskRefType;
...
typedef   TickType OS_VAR_NOINIT_FAST * TickRefType;
...
/*! This data type points to the data type TickType. */
typedef   AlarmBaseType OS_VAR_NOINIT_FAST * AlarmBaseRefType;
 ...
 *  \trace SPEC-63574 */
typedef   ApplicationStateType OS_VAR_NOINIT_FAST * ApplicationStateRefType;
...
typedef   Os_ErrorInformationType OS_APPL_VAR * Os_ErrorInformationRefType;
 ...
 *  \trace SPEC-63568 */
typedef const   void OS_VAR_NOINIT * MemoryStartAddressType;
