 ...
 *  \retval       ((void *)0)    If there is no connection to the requested core.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigSendPortConfigType OS_CONST *   Os_XSigGetSendPort (
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_ObjIdxType   Os_XSigGetRecvIsrCount (
  const   Os_XSigConfigType OS_CONST * XSignal
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigIsrConfigType OS_CONST *   Os_XSigGetRecvIsr (
  const   Os_XSigConfigType OS_CONST * XSignal,
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigSendPortConfigType OS_CONST *   Os_XSigGetSendPortToCore (
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_XSigRecvCheckIsFunctionAvailable (
 ...
 *  \pre          The given index is in a valid range.
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType   Os_XSigRecvCheckIsReceiveElementValid (
    const   Os_XSigComDataConfigType OS_VAR_NOINIT * XSigRecvElement
);
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(static inline Os_StatusType,    ,
...
(
  ...
  Os_XSigState_Type Acknowledge,
    Os_XSigComDataConfigRefType OS_VAR_NOINIT * ComData
));
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline OSServiceIdType   Os_XSigFunctionIdx2ServiceId (
  Os_XSigFunctionIdx FunctionIdx
);
 ...
 *  \trace        SPEC-63727
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigHandleResults (
  const   Os_XSigChannelSendConfigType OS_CONST * SendChannel
);
 ...
 *  \details      --no details--
 *
 *  \param[in,out]    SendPort    The send port to initialize. ((void *)0) is allowed.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigSendPortInit (
  const   Os_XSigSendPortConfigType OS_CONST * SendPort
);
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigRecvPortInit (
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigIsrInit (
  const   Os_XSigIsrConfigType OS_CONST * XSigIsr
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigIsrConfigType OS_CONST *   Os_XSigThread2XSigIsr (
 ...
 *  Os_XSigGetSendPort()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigSendPortConfigType OS_CONST * /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
    Os_XSigGetSendPort (
  const   Os_XSigConfigType OS_CONST * XSignal,
  Os_CoreAsrCoreIdx SendPortIdx
 ...
 *  Os_XSigGetRecvIsrCount()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_ObjIdxType   Os_XSigGetRecvIsrCount /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_XSigConfigType OS_CONST * XSignal
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *  Os_XSigGetRecvIsr()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigIsrConfigType OS_CONST * /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
    Os_XSigGetRecvIsr (
  const   Os_XSigConfigType OS_CONST * XSignal,
  Os_ObjIdxType IsrIdx
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
...
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  {
    result = (Os_StdReturnType)(XSigIsr->FunctionTable->FunctionDescription[FunctionIdx].FunctionRef != ((void *)0));      /* PRQA S 2842, 4304 */ /* MD_Os_Rule18.1_2842_Check, MD_Os_C90BooleanCompatibility */
  }
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(static inline Os_StatusType,    ,                                                    /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
OS_ALWAYS_INLINE, Os_XSigSendInternal,
(
  const   Os_XSigSendPortConfigType OS_CONST * SendPort,
  const   Os_ThreadConfigType OS_CONST * SendThread,
 ...
 *  Os_XSigFunctionIdx2ServiceId()
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline OSServiceIdType   Os_XSigFunctionIdx2ServiceId /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  Os_XSigFunctionIdx FunctionIdx
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_XSigHandleResults /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_XSigChannelSendConfigType OS_CONST * SendChannel
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
  ...
  {
    const   Os_XSigComDataConfigType OS_CONST * comData;
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_XSigSendPortInit /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_XSigSendPortConfigType OS_CONST * SendPort
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_XSigRecvPortInit /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_XSigRecvPortConfigType OS_CONST * RecvPort
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
 ...
 *
 */
OS_ALWAYS_INLINE static inline void   Os_XSigIsrInit /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
    const   Os_XSigIsrConfigType OS_CONST * XSigIsr
)                                                                                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
{
...
{
  return (const   Os_XSigIsrConfigType OS_CONST *)Thread;                                                    /* PRQA S 0310 */ /* MD_Os_Rule11.3_0310 */
}
    ...
    for(it = 0; it < (Os_ObjIdx_IteratorType) xSigIsr->RecvPortCount; ++it)
    {
      ...
      if(Os_CoreIsStartedAsAsr(Os_CoreAsr2Core(sendCore)) != 0u)                                                        /* SBSW_OS_XSIG_COREISSTARTEDASASR */ /* SBSW_OS_XSIG_COREASR2CORE_001 */
      {
        ...
        if(Os_XSigChannelReceiveCheckInRange(&(recvPort->RecvChannel)) != 0u)                                           /* SBSW_OS_XSIG_XSIGCHANNELRECEIVECHECKINRANGE */
        {
          ...
          {
            const   Os_XSigComDataConfigType OS_CONST * comData;
            const   Os_XSigSendDataType volatile OS_VAR_NOINIT * sendData;
            ...
            if(Os_XSigRecvCheckIsReceiveElementValid(comData) != 0u)                                                    /* SBSW_OS_XSIGRECVCHECKISRECEIVEELEMENTVALID_001 */
            {
              ...
              else
              {
                ...
                inParameter = ((const   Os_XSigParamsType OS_VAR_NOINIT *)&(sendData->ParameterData));       /* PRQA S 0312 */ /* MD_Os_Rule11.8_0312_Volatile */ /* COMP_WARN_OS_VOLATILE_CAST */
                outParameter = ((  Os_XSigOutputParamsType OS_VAR_NOINIT *)                              /* PRQA S 0312 */ /* MD_Os_Rule11.8_0312_Volatile */ /* COMP_WARN_OS_VOLATILE_CAST */
 ...
 *
 */
Os_StatusType     Os_XSigSendAsync                                                                           /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  const   Os_CoreAsrConfigType OS_CONST * RecvCore,
  const   Os_ThreadConfigType OS_CONST * SendThread,
  Os_XSigFunctionIdx FunctionIdx,
...
)
{
  ...
  if(Os_XSigIsEnabled() != 0u)                                                                                          /* PRQA S 2991, 2992, 2995, 2996 */ /* MD_Os_Rule14.3_2991, MD_Os_Rule14.3_2992, MD_Os_Rule2.2_2995, MD_Os_Rule2.2_2996 */
  {
    ...
    if(OS_UNLIKELY(sendPort == ((void *)0)))
    {
 ...
 *
 */
Os_StatusType     Os_XSigSendSync                                                                            /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
  const   Os_CoreAsrConfigType OS_CONST * RecvCore,
  const   Os_ThreadConfigType OS_CONST * SendThread,
  Os_XSigFunctionIdx FunctionIdx,
 ...
 *
 */
Os_StatusType     Os_XSigRecv_ActivateTask                                                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                 /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
)
{
  Os_StatusType status;
  TaskType taskId;
  ...
  {
    const   Os_TaskConfigType OS_CONST * taskRef;
    const   Os_CoreAsrConfigType OS_CONST * taskCore;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetTaskState                                                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetCounterValue                                                                /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
)
{
  ...
  {
    const   Os_CounterConfigType OS_CONST * counterRef;
    const   Os_CoreAsrConfigType OS_CONST * counterCore;
    Os_AppAccessMaskType permittedApplications;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_SetEvent                                                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetEvent                                                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetAlarm                                                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
)
{
  ...
  {
    const   Os_AlarmConfigType OS_CONST * alarmRef;
    const   Os_CoreAsrConfigType OS_CONST * alarmCore;
    Os_AppAccessMaskType permittedApplications;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_SetRelAlarm                                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
 ...
 *
 */
Os_StatusType     Os_XSigRecv_SetAbsAlarm                                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
 ...
 *
 */
Os_StatusType     Os_XSigRecv_CancelAlarm                                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
 ...
 *
 */
Os_StatusType     Os_XSigRecv_StartScheduleTableRel                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
)
{
  ...
  {
    const   Os_SchTConfigType OS_CONST * schTRef;
    const   Os_CoreAsrConfigType OS_CONST * schTCore;
    Os_AppAccessMaskType permittedApplications;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_StartScheduleTableAbs                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
 ...
 *
 */
Os_StatusType     Os_XSigRecv_StopScheduleTable                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
 ...
 *
 */
Os_StatusType     Os_XSigRecv_NextScheduleTable                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
)
{
  ...
  {
    const   Os_SchTConfigType OS_CONST * schTRef_From;
    const   Os_SchTConfigType OS_CONST * schTRef_To;
    const   Os_CoreAsrConfigType OS_CONST * schTFromCore;
    const   Os_CoreAsrConfigType OS_CONST * schTToCore;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetScheduleTableStatus                                                         /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetTaskStackUsage                                                              /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetISRStackUsage                                                               /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
)
{
  ...
  {
    const   Os_IsrConfigType OS_CONST * isrRef;
    const   Os_CoreAsrConfigType OS_CONST * isrCore;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_ControlIdle                                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                 /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
)
{
  ...
  else
  {
    ...
    {
      const   Os_CoreAsrConfigType OS_CONST * coreRef;
      ...
      {
        const   Os_CoreAsrConfigType OS_CONST * localCore;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetKernelStackUsage                                                            /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetStartupHookStackUsage                                                       /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetErrorHookStackUsage                                                         /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetShutdownHookStackUsage                                                      /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetProtectionHookStackUsage                                                    /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetNonTrustedFunctionStackUsage                                                /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
)
{
  ...
  {
    const   Os_ServiceNtfConfigType OS_CONST * nonTrustedFunction;
    const   Os_CoreAsrConfigType OS_CONST * coreRef;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_TerminateApplication                                                           /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
)
{
  ...
  {
    const   Os_AppConfigType OS_CONST * appRef;
    const   Os_CoreAsrConfigType OS_CONST * appCore;
 ...
 *
 */
Os_StatusType     Os_XSigRecv_GetApplicationState                                                            /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
  const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
  const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
    Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter
...
Os_StatusType     Os_XSigRecv_ShutdownAllCores                                                               /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
...
Os_StatusType     Os_XSigRecv_HookCallCallback                                                               /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */
(
 const   Os_AppConfigType OS_VAR_NOINIT * SendApp,
 const   Os_XSigParamsType OS_VAR_NOINIT * InParameter,
   Os_XSigOutputParamsType OS_VAR_NOINIT * OutParameter                                                  /* PRQA S 3673 */ /* MD_MSR_Rule8.13 */
)
{
  ...
  {
    const   Os_HookConfigType OS_CONST * callbackRef;
    const   Os_CoreAsrConfigType OS_CONST * callbackCore;
...
\CM CM_OS_XSIGRECVPORTGETSENDPORT_M
      Verify that the SendPort of each Os_XSigRecvPortConfigType object is a non ((void *)0).

\CM CM_OS_XSIGSENDPORTGETSENDCORE_M
      Verify that the SendCore of each Os_XSigSendPortConfigType object is a non ((void *)0).
...
\CM CM_OS_XSIGGETSENDPORTTOCORE_02_02_R
      Implementation ensures, that the returned value is not used if it is a ((void *)0).

\CM CM_OS_XSIGGETSENDPORT_01_02_R
      The called function ensures, that the returned pointer is not used for write accesses, if the pointer is ((void *)0).
...
\CM CM_OS_XSIGGETRECVISR_01_02_M
      Verify that:
        1. RecvIsrRefs of each Os_XSigConfigType object is a non ((void *)0) except the last one,
        2. RecvIsrRefs has a size equal to RecvIsrCount + 1 and
        3. that each XSignal's RecvIsrRefs pointer is no ((void *)0).

\CM CM_OS_XSIGGETRECVISR_02_02_R
      Implementation ensures that the index passed to Os_XSigGetSendPort is valid.

\CM CM_OS_XSIGSENDPORT_ISR_M
      Verify that the XSigIsr reference of each SendPort instance is a non ((void *)0).

\CM CM_OS_XSIGISR_HWCONFIG_M
      Verify that the HwConfig reference of each XSigIsr instance is a non ((void *)0).

\CM CM_OS_XSIGCOM_SENDDATA_M
      Verify that each SendData reference of each XSigCom instance is a non ((void *)0).

\CM CM_OS_XSIGCOM_RECEIVCEDATA_M
      Verify that each RecvData reference of each XSigCom instance is a non ((void *)0).

\CM CM_OS_XSIGCHANNELGETRESULT_01_04_M
      Verify that the Buffer reference of each XSigSendPort instance is a non ((void *)0).
...
\CM CM_OS_XSIGCHANNELGETRESULT_03_04_M
      Verify that the Dyn reference of each XSigSendPort instance is a non ((void *)0).
...
\CM CM_OS_XSIGISR_RECVPORTREFS_01_03_M
      Verify that the RecvPortRefs reference of each XSigIsr instance is a non ((void *)0).
...
\CM CM_OS_XSIGRECVPORT_M
      Verify that each entry of each RecvPort instance is a non ((void *)0) except the last one.
...
\CM CM_OS_XSIGISR_FUNCTIONTABLE_M
      Verify that the FunctionTable reference of each XSigIsr is a non ((void *)0).
...
\CM CM_OS_XSIGFUNCTIONTABLE_FUNCTIONDESCRIPTION_M
      ...
      enum identifier or that the function reference is a ((void *)0).

\CM CM_OS_XSIGCHANNELGETRECEIVEELEMENT_01_03_M
      Verify that the Buffer reference of each XSigChannelRecv instance is a non ((void *)0).
...
\CM CM_OS_XSIGCHANNELGETSENDELEMENT_R
      Implementation ensures that the pointer is not used, if it is a ((void *)0).
...
\CM CM_OS_XSIGCHANNELSEND_DYN_M
      Verify that the Dyn reference of each XSigChannelSend instance is a non ((void *)0).

\CM CM_OS_XSIGCHANNELRECV_DYN_M
      Verify that the Dyn reference of each XSigChannelRecv instance is a non ((void *)0).

\CM CM_OS_XSIGCHANNELSEND_BUFFER_01_02_M
      Verify that the Buffer reference of each XSigChannelSend instance is a non ((void *)0).
