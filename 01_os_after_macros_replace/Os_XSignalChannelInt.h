...
typedef struct
{
  /*! Send port which holds the function call information. */
    Os_XSigSendDataType volatile OS_VAR_NOINIT * SendData;

  /*! Receive port which holds the response/result of the call. */
    Os_XSigRecvDataType volatile OS_VAR_NOINIT * RecvData;

  /*! The index of the ComData in the queue. */
  Os_XSigBufferIdxType Idx;
}Os_XSigComDataConfigType;
typedef const   Os_XSigComDataConfigType OS_CONST * Os_XSigComDataConfigRefType;
...
typedef const   Os_XSigOutputParamsType OS_CONST * Os_XSigOutputParamsRefType;
...
struct Os_XSigSendDataType_Tag
{
  ...
  const   Os_ThreadConfigType OS_CONST * Sender;

  /*! Pointer to the sender application. */
  const   Os_AppConfigType OS_CONST * SenderApp;
...
typedef struct
{
  /*! Pointer to the runtime send data. */
    Os_XSigChannelSendType volatile OS_VAR_NOINIT * Dyn;

  /*! Pointer to the runtime receive data. */
  const   Os_XSigChannelRecvType volatile OS_VAR_NOINIT * Receive;

  /*! Pointer to the buffer array. */
  const   Os_XSigComDataConfigType OS_CONST * Buffer;
...
{
  /*! Pointer to the runtime receive data. */
    Os_XSigChannelRecvType volatile OS_VAR_NOINIT * Dyn;

  /*! Pointer to the runtime send data. */
  const   Os_XSigChannelSendType volatile OS_VAR_NOINIT * Send;
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigChannelIdxIncrement (
    Os_XSigBufferIdxType volatile OS_APPL_DATA * Index,
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigChannelSendInit (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel
);
 ...
 *
 *  \retval         ((void *)0)    If there is no send element available.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE for different Channels
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigComDataConfigType OS_CONST *   Os_XSigChannelGetSendElement (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigChannelSend (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline const   Os_XSigComDataConfigType OS_CONST *   Os_XSigChannelGetResult (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel
);
 ...
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline void   Os_XSigChannelFreeResult (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_XSigChannelIsResultAvailable (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel
);
...
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_XSigChannelIsRequestHandled (
  const   Os_XSigChannelSendConfigType OS_APPL_DATA * Channel,
...
Os_XSigChannelReceiveInit (
  const   Os_XSigChannelRecvConfigType OS_APPL_DATA * Channel
);
...
const   Os_XSigComDataConfigType OS_VAR_NOINIT *   Os_XSigChannelGetReceiveElement (
  const   Os_XSigChannelRecvConfigType OS_APPL_DATA * Channel
);
 ...
 **********************************************************************************************************************/
/* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_XSigChannelIsReceiveElementAvailable (
  const   Os_XSigChannelRecvConfigType OS_APPL_DATA * Channel
);
 ...
 **********************************************************************************************************************/
/* PRQA S 3219 */ /* MD_Os_Rule2.1_3219 */
OS_ALWAYS_INLINE static inline Os_StdReturnType OS_CONST Os_XSigChannelReceiveCheckInRange (
  const   Os_XSigChannelRecvConfigType OS_APPL_DATA * Channel
);
